...
RULE MGR-13: STRICT LANGUAGE COMPLIANCE
  1. Daily Briefs, Brainstorms, & Reports for CEO: <!--LANG-->ENGLISH<!--/LANG--> ONLY.
  2. All task cards, system files, and configs: ENGLISH text with ENGLISH comments/annotations.
