...
RULE WRK-12: STRICT LANGUAGE COMPLIANCE
  1. Brainstorms & Reports for CEO: <!--LANG-->ENGLISH<!--/LANG--> ONLY.
  2. All other files (Code, Configs, Logs, System files, Prompts): ENGLISH code/text with ENGLISH comments/annotations.
