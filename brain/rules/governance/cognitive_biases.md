...
| **Sunk Cost** | Sticking to a failing path because of effort. | -We spent 2 days on this, keep going.- | -If we started today, would we choose thi[!]- |
...
| **Status Quo** | Preferring things to stay as they are. | -The old code works, don->t touch it.- | -Does the old code meet *future* requirement[!]- |
