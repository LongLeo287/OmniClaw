...
LLM tier: see brain/corp/departments/it_infra/config.yaml or brain/corp/departments/it_infra/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'it_infra' category
