...
LLM tier: see brain/corp/departments/hr_people/config.yaml or brain/corp/departments/hr_people/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'hr_people' category
