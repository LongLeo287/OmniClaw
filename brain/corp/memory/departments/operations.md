...
LLM tier: see brain/corp/departments/operations/config.yaml or brain/corp/departments/operations/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'operations' category
