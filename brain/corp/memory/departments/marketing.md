...
LLM tier: see brain/corp/departments/marketing/config.yaml or brain/corp/departments/marketing/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'marketing' category
