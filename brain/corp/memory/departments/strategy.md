...
LLM tier: see brain/corp/departments/strategy/config.yaml or brain/corp/departments/strategy/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'strategy' category
