# content_review — Department Memory
# Owner: Dept Head | Retention: 30-day rolling | Layer: Department
# Updated: 2026-03-17 | Format: see brain/corp/memory/MEMORY_SPEC.md

## Always-Load Context
Dept: content_review
Escalation path: see brain/corp/org_chart.yaml
LLM tier: see brain/corp/departments/content_review/config.yaml or brain/corp/departments/content_review/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'content_review' category
