...
LLM tier: see brain/corp/departments/finance/config.yaml or brain/corp/departments/finance/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'finance' category
