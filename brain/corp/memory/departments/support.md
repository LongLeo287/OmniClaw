...
LLM tier: see brain/corp/departments/support/config.yaml or brain/corp/departments/support/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'support' category
