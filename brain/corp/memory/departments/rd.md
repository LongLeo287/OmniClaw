...
LLM tier: see brain/corp/departments/rd/config.yaml or brain/corp/departments/rd/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'rd' category
