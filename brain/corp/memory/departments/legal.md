...
LLM tier: see brain/corp/departments/legal/config.yaml or brain/corp/departments/legal/MANAGER_PROMPT.md
Primary skills: check SKILL_REGISTRY.json for 'legal' category
