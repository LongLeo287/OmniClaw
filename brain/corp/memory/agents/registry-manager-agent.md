# Agent Memory — registry-manager-agent
# Title: Agent & Capability Registry Manager | Dept: registry_capability
...
Primary skills: neural_navigator, sequential-thinking, registry-indexer, schema-validator
Department: registry_capability
KPIs tracked: registry_consistency_score, schema_validation_pass_rate, stale_registry_entries
