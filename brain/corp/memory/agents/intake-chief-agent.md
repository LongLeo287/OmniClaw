# Agent Memory — intake-chief-agent
# Title: Content Intake Chief | Dept: content_intake
...
Primary skills: neural_navigator, sequential-thinking, intake-classifier, priority-ranker
Department: content_intake
KPIs tracked: intake_classification_accuracy, avg_routing_time, sla_compliance_rate
