# Agent Memory — library-manager-agent
# Title: Skill & Plugin Library Manager | Dept: archivist
...
Primary skills: neural_navigator, sequential-thinking, registry-indexer, dependency-mapper
Department: archivist
KPIs tracked: skill_registry_completeness, plugin_availability_rate, skill_search_accuracy
