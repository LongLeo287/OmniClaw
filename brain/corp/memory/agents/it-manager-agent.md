# Agent Memory — it-manager-agent
# Title: IT Infrastructure Manager | Dept: it_infra
...
Primary skills: neural_navigator, sequential-thinking, shell_assistant, network-monitor
Department: it_infra
KPIs tracked: infrastructure_uptime, dependency_freshness, incident_resolution_time
