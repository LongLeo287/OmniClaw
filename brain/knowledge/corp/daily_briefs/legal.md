...
owner: SYSTEM
tags: [auto-healed]
healed_at: 2026-04-03T22:44:27.644899
---

# Daily Brief â€” Legal & Compliance â€” 2026-03-20
...
|------|---------|---------------|-----------------|--------|
| NVIDIA/NemoClaw | Apache 2.0 | âœ… YES | Name + notice | COMPLIANT |
| code-on-sunday/slide-deck-generator | MIT | âœ… YES | Name only | COMPLIANT |
| (107+ other repos in corpus) | Mixed (mostly MIT/Apache) | âœ… Majority YES | Varies | REVIEW RECOMMENDED |
...
- All markdown files in `corp/`, `brain/memory/`, `workflows/`
- All MQ task cards
...
## Wins
- First legal framework for Corp â€” IP clarity established
