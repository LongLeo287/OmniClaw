...
| L4 | CEO (CEO) | Strategic or critical infra | CEO decision required |
...
| SUP-003 | Telegram bot token not configured | Operations | 🔴 OPEN — needs CEO to add token | Operations |
