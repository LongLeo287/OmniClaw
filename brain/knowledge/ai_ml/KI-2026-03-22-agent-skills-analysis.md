---
id: KI-2026-03-22-agent-skills-analysis
source: https://2026-03-19-agent-skills-analysis.vercel.app/
type: REFERENCE
domain: ai-ml
dept: rd, engineering
stars: —
...
- 3-Tier Progressive Disclosure: Trigger (YAML) → SOP detail → References
- SOP encodes voice + logic: rules about terminology, tone, format
- AI doesn't start from 0 when Skill exists — just invoke by name
- Chatbot: ad-hoc prompts | Agent with Skill: structured SOP execution
- Skills enable: brand voice, admin docs (NĐ30), content creation
- References/ folder: loaded on demand for deep info only
