---
id: awesome-ddd-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:18:54.863895
---

# KNOWLEDGE EXTRACT: awesome-ddd
> **Extracted on:** 2026-03-30 17:30:31
> **Source:** awesome-ddd
...
[Here](https://github.com/RichardLitt/brain/knowledge/docs_legacy/blob/master/amending-a-commit-guide.md) is a write up on how to change a Pull Request, and the different ways you can do that.
```
...
**[Command Query Responsibility Segregation (CQRS)](http://codebetter.com/gregyoung/2010/02/16/cqrs-ta[REDACTED_API_KEY]/)** is simply the creation of two objects where there was previously only one. The separation occurs based upon whether the methods are a command or a query (the same definition that is used by Meyer in Command and Query Separation, a command is any method that mutates state and a query is any method that returns a value).
...
- [Booster framework examples](https://github.com/boostercloud/booster/tree/master/brain/knowledge/docs_legacy/examples) Example applications built with Booster Framework.
...
- [SeedStack's Business Framework](http://seedstack.org/brain/knowledge/docs_legacy/business/) - A set of building blocks that enable you to code business logic according to the Domain-Driven Design (DDD) approach.
