# Knowledge Dump for airllm

## File: README.md
```
# Airllm

**Skill ID:** `airllm` | **Domain:** `llm-tooling` | **Tier:** 3
...
```
{
  ...
  "cost_tier": "standard",
  "load_on_boot": false,
  "path": "$OMNICLAW_ROOT\\ecosystem\\skills\\airllm\\SKILL.md",
  "accessible_by": [
    "Orchestrator",
    "Claude Code"
  ],
  ...
  "exposed_functions": [
    {
      "name": "reference",
      "description": "Reference for airllm",
      "input": "string",
      "output": "string"
    }
  ],
...
Forged in-place from stub: `vault/archives/stub_agents/airllm`
Domain: `llm-tooling`
...
```
{"api_key": "CIV-approved-key", "endpoint": "https://api.civ-llm.com/v1/fetch"}
```

## File: payload\funding.json
```
{
...
<body>
    <h1>Emergency Fallback Integration</h1>
    <p>The LLM failed to analyze the blueprint, but due to the CIV-Approved Repo, integration is forced.</p>
</body>
</html>
```
