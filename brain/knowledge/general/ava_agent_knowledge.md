...
## File: agent.md
```
# AGENT: Ava Agent - Auto-Scaffolded Agent for ava
...
**Memory file:** `corp/memory/agents/ava-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-30T22:28:35.812395+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-30T22:28:35.812395+07:00",
  "version": "1.0"
}
```
...
*Ava Agent - Created by OmniClaw OS agent-auto-create workflow. Supervised until first performance review.*
```

## File: SKILL.md
```
# SKILL PROFILE: ava_agent
...
```
# SYSTEM PROMPT
You are **<Agent Name>** (`ava_agent`), a highly specialized expert operating within the **Dept 2 (Engineering)** department of the OmniClaw Autonomous Ecosystem.
