...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:16.495947
---
...
### Agent Prompt (paste into core/user prompt)
...
- **[brain/knowledge/docs_legacy/workflows/brownfield.md](brain/knowledge/docs_legacy/workflows/brownfield.md)** — detailed brownfield workflow
- **[brain/knowledge/docs_legacy/workflows/greenfield.md](brain/knowledge/docs_legacy/workflows/greenfield.md)** — detailed greenfield workflow
- **[brain/knowledge/docs_legacy/comparisons/](brain/knowledge/docs_legacy/comparisons/)** — DSP vs GSD, DSP vs Superpowers, and related notes
...
| Agent | Install |
|---|---|
| **Claude Code** | `npm i -g @anthropic-ai/claude-code` — [docs](https://docs.anthropic.com/en/brain/knowledge/docs_legacy/claude-code/setup) |
...
> Modern agents are smarter than most mid-level engineers. They plan, they test, they verify. They just can't remember your project. DSP is the fix. [Detailed comparison with GSD](./brain/knowledge/docs_legacy/comparisons/dsp-vs-gsd.md) | [Detailed comparison with Superpowers](./brain/knowledge/docs_legacy/comparisons/dsp-vs-superpowers.md)
...
| [**brain/knowledge/docs_legacy/comparisons/**](./brain/knowledge/docs_legacy/comparisons/) | Detailed comparisons with GSD, Superpowers, and other tools |
| [**brain/knowledge/docs_legacy/workflows/**](./brain/knowledge/docs_legacy/workflows/) | Workflow guides — bootstrap, brownfield adoption, team usage |
...
## File: `brain/knowledge/docs_legacy/comparisons/dsp-vs-gsd.md`
```markdown
...
## File: `brain/knowledge/docs_legacy/comparisons/dsp-vs-superpowers.md`
```markdown
# DSP vs Superpowers
...
## File: `brain/knowledge/docs_legacy/workflows/brownfield.md`
```markdown
...
## File: `brain/knowledge/docs_legacy/workflows/greenfield.md`
```markdown
