---
id: github.com-google-labs-code-stitch-skills-f73b7c86
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:54.959976
---

# KNOWLEDGE EXTRACT: github.com_google-labs-code_stitch-skills_f73b7c86
> **Extracted on:** 2026-04-01 08:58:38
> **Source:** D:/LongLeo/AI OS CORP/AI OS/core/security/QUARANTINE/KI-BATCH-20260331205007519893/github.com_google-labs-code_stitch-skills_f73b7c86
...
## File: `skills/design-md/README.md`
```markdown
...
- Access to the Stitch Effective Prompting Guide: https://stitch.withgoogle.com/brain/knowledge/docs_legacy/learn/prompting/
...
3. **Reference best practices:**
   ...
   https://stitch.withgoogle.com/brain/knowledge/docs_legacy/learn/prompting/
   ```
...
## File: `skills/design-md/examples/DESIGN.md`
```markdown
...
## File: `skills/enhance-prompt/README.md`
```markdown
...
## File: `skills/enhance-prompt/SKILL.md`
```markdown
---
name: enhance-prompt
...
- **Stitch Effective Prompting Guide**: https://stitch.withgoogle.com/brain/knowledge/docs_legacy/learn/prompting/
...
## File: `skills/enhance-prompt/references/KEYWORDS.md`
```markdown
...
## File: `skills/react-components/README.md`
```markdown
...
## File: `skills/react-components/SKILL.md`
```markdown
---
...
## File: `skills/react-components/package.json`
```json
{
  "name": "react-components",
  "version": "1.0.0",
...
## File: `skills/react-components/examples/gold-standard-card.tsx`
```tsx
/**
...
## File: `skills/react-components/resources/architecture-checklist.md`
```markdown
...
## File: `skills/react-components/resources/component-template.tsx`
```tsx
/**
 * Copyright 2026 Google LLC
 *
...
## File: `skills/react-components/resources/stitch-api-reference.md`
```markdown
...
## File: `skills/react-components/resources/style-guide.json`
```json
{
  "theme": {
    "colors": {
...
## File: `skills/react-components/scripts/fetch-stitch.sh`
```bash
#!/bin/bash
# Copyright 2026 Google LLC
#
...
## File: `skills/react-components/scripts/validate.js`
```javascript
/**
 * Copyright 2026 Google LLC
 *
...
## File: `skills/remotion/README.md`
```markdown
...
See the full [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) for detailed instructions, troubleshooting, and best practices.
...
- **Stitch Documentation**: https://stitch.withgoogle.com/brain/knowledge/docs_legacy/
- **Remotion Documentation**: https://www.remotion.dev/brain/knowledge/docs_legacy/
- **Remotion Skills**: https://www.remotion.dev/brain/knowledge/docs_legacy/ai/skills
- **Remotion MCP**: https://www.remotion.dev/brain/knowledge/docs_legacy/ai/mcp
- **Remotion Transitions**: https://www.remotion.dev/brain/knowledge/docs_legacy/transitions
```

## File: `skills/remotion/examples/WalkthroughComposition.tsx`
```tsx
...
## File: `skills/remotion/examples/screens.json`
```json
{
  "projectName": "Calculator App",
...
## File: `skills/remotion/resources/composition-checklist.md`
```markdown
...
## File: `skills/remotion/resources/screen-slide-template.tsx`
```tsx
...
## File: `skills/remotion/scripts/download-stitch-asset.sh`
```bash
#!/bin/bash
...
## File: `skills/shadcn-ui/README.md`
```markdown
...
Contributions to improve this skill are welcome! See the root [CONTRIBUTING.md](../bmad_repo/CONTRIBUTING.md) for guidelines.
...
## File: `skills/shadcn-ui/examples/auth-layout.tsx`
```tsx
...
## File: `skills/shadcn-ui/examples/data-table.tsx`
```tsx
...
## File: `skills/shadcn-ui/examples/form-pattern.tsx`
```tsx
...
## File: `skills/shadcn-ui/resources/component-catalog.md`
```markdown
...
- [Official Component Docs](https://ui.shadcn.com/brain/knowledge/docs_legacy/components)
- [Component Examples](https://ui.shadcn.com/examples)
- [Radix UI Primitives](https://www.radix-ui.com/primitives)
```

## File: `skills/shadcn-ui/resources/customization-guide.md`
```markdown
...
- [Tailwind CSS Customization](https://tailwindcss.com/brain/knowledge/docs_legacy/theme)
- [CVA Documentation](https://cva.style/docs)
- [Radix UI Theming](https://www.radix-ui.com/themes/brain/knowledge/docs_legacy/theme/overview)
- [HSL Color Theory](https://www.w3.org/TR/css-color-3/#hsl-color)
```

## File: `skills/shadcn-ui/resources/migration-guide.md`
```markdown
...
## File: `skills/shadcn-ui/resources/setup-guide.md`
```markdown
...
## File: `skills/shadcn-ui/scripts/verify-setup.sh`
```bash
#!/usr/bin/env bash
...
## File: `skills/stitch-design/README.md`
```markdown
# Stitch Design Skill
...
See [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) for complete instructions.
```

## File: `skills/stitch-design/SKILL.md`
```markdown
---
name: stitch-design
...
|:---|:---|:---|
| "Design a [page]..." | [text-to-design](../../../ecosystem/skills/stitch-design/workflows/text-to-design.md) | `generate_screen_from_text` + `Download` |
| "Edit this [screen]..." | [edit-design](../../../ecosystem/skills/stitch-design/workflows/edit-design.md) | `edit_screens` + `Download` |
| "Create/Update .stitch/DESIGN.md" | [generate-design-md](../../../ecosystem/skills/stitch-design/workflows/generate-design-md.md) | `get_screen` + `Write` |
...
Consult [Design Mappings](design-mappings.md) to replace vague terms.
...
- [Tool Schemas](tool-schemas.md) — How to call Stitch MCP tools.
- [Design Mappings](design-mappings.md) — UI/UX keywords and atmosphere descriptors.
- [Prompting Keywords](prompt-keywords.md) — Technical terms Stitch understands best.
...
## File: `skills/stitch-design/examples/DESIGN.md`
```markdown
---
...
## File: `skills/stitch-design/examples/enhanced-prompt.md`
```markdown
...
## File: `skills/stitch-design/examples/metadata.json`
```json
{
...
## File: `skills/stitch-design/references/design-mappings.md`
```markdown
...
## File: `skills/stitch-design/references/prompt-keywords.md`
```markdown
# UI/UX Keywords Reference
...
## File: `skills/stitch-design/references/tool-schemas.md`
```markdown
...
## File: `skills/stitch-design/workflows/edit-design.md`
```markdown
---
...
## File: `skills/stitch-design/workflows/generate-design-md.md`
```markdown
---
...
## File: `skills/stitch-design/workflows/text-to-design.md`
```markdown
---
...
Before calling the Stitch MCP tool, apply the [Prompt Enhancement Pipeline](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md#prompt-enhancement-pipeline). 
- Identify the platform (Web/Mobile) and page type.
- Incorporate any existing project design system from `.stitch/DESIGN.md`.
- Use specific [Design Mappings](design-mappings.md) and [Prompting Keywords](prompt-keywords.md).
...
### 6. Review and Refine
- If the result is not exactly as expected, use the [edit-design](../../../ecosystem/skills/stitch-design/workflows/edit-design.md) workflow to make targeted adjustments.
...
## File: `skills/stitch-loop/README.md`
```markdown
...
## File: `skills/stitch-loop/SKILL.md`
```markdown
---
name: stitch-loop
...
## File: `skills/stitch-loop/examples/SITE.md`
```markdown
---
...
## File: `skills/stitch-loop/examples/next-prompt.md`
```markdown
---
page: contact
---
...
## File: `skills/stitch-loop/resources/baton-schema.md`
```markdown
# Baton File Schema
...
## File: `skills/stitch-loop/resources/site-template.md`
```markdown
# Site Template
...
## File: `skills/taste-design/SKILL.md`
```markdown
---
name: taste-design
...
- No fake core/metric sections — "SYSTEM PERFORMANCE METRICS", "KEY STATISTICS", "BY THE NUMBERS" dashboard cards filled with invented data are BANNED
...
## File: `skills/taste-design/resources/DESIGN.md`
```markdown
