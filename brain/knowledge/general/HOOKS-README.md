...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:28:52.760796
---

# HOOKS-README
contains all the details, scripts, and instructions for the hooks

## Hook Events Overview - [Official 19 Hooks](https://code.claude.com/brain/knowledge/docs_legacy/en/hooks)
...
The following items exist in the [Claude Code Changelog](https://github.com/anthropics/claude-code/blob/main/CHANGELOG.md) but are **not listed** in the [Official Hooks Reference](https://code.claude.com/brain/knowledge/docs_legacy/en/hooks):
