# Knowledge Dump for claude-code-startup-skills
...
## File: _GIT_INGEST.md
```
# OmniClaw Repo Plow: CIV_FETCHED_claude-code-startup-skills_212852
...
================================================
{
  "name": "startup",
  "version": "1.0.0",
  "description": "Claude Code skills for building startups, SaaS, and software businesses",
  "author": {
    "name": "rameerez",
    "url": "https://github.com/rameerez"
  },
  "repository": "https://github.com/rameerez/claude-code-startup-skills",
  "license": "MIT",
  "keywords": ["startup", "saas", "seo", "video", "images", "social-media"]
}
...
================================================
FILE: skills\transcribe-video\SKILL.md
================================================
---
...
def upload_video(session, filepath):
    ...
    # Wait for processing
    while processing_info and processing_info.get("state") not in ("succeeded", No
```
