---
id: jsonnet-bundler-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:28:56.636518
---

# KNOWLEDGE EXTRACT: jsonnet-bundler
> **Extracted on:** 2026-03-30 17:38:13
> **Source:** jsonnet-bundler

---

## File: `jsonnet-bundler.md`
```markdown
# 📦 jsonnet-bundler/jsonnet-bundler [🔖 PENDING/APPROVE]
...
Commands:
  ...
  install [<flags>] [<uris>...]
    Install new dependencies. Existing ones are silently sk
```
