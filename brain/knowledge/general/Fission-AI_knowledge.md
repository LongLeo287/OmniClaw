---
id: fission-ai-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:24.771845
---

# KNOWLEDGE EXTRACT: Fission-AI
> **Extracted on:** 2026-03-30 17:37:13
> **Source:** Fission-AI
...
> [!NOTE]
> Not sure if your tool is supported? [View the full list](supported-tools.md) – we support 20+ tools and growing.
>
> Also works with pnpm, yarn, bun, and nix. [See installation options](installation.md).

## Docs

→ **[Getting Started](../bmad_repo/getting-started.md)**: first steps<br>
→ **[Workflows](workflows.md)**: combos and patterns<br>
→ **[Commands](../bmad_repo/commands.md)**: slash commands & skills<br>
...
See [MAINTAINERS.md](../../../core/security/QUARANTINE/vetted/repos/openclaw/.agents/maintainers.md) for the list of core maintainers and advisors who help guide the project.
