---
id: web-llm-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:32:46.064795
---

# KNOWLEDGE EXTRACT: web-llm
> **Extracted on:** 2026-03-30 13:17:33
> **Source:** web-llm
...
## File: `examples/integrity-verification/package.json`
```json
{
...
## File: `examples/integrity-verification/src/integrity_verification.html`
```html
<!doctype html>
<html>
  <body>
...
## File: `examples/integrity-verification/src/integrity_verification.ts`
```typescript
import * as webllm from "@mlc-ai/web-llm";
...
## File: `examples/next-simple-chat/.gitignore`
```
...
## File: `examples/simple-chat-ts/.gitignore`
```
src/app-config.js
```
...
## File: `examples/simple-chat-upload/.gitignore`
```
src/app-config.js
```
...
## File: `examples/structural-tag-tool-use/package.json`
```json
{
...
## File: `examples/structural-tag-tool-use/README.md`
```markdown
...
## File: `examples/structural-tag-tool-use/src/mcp_structural_tag.html`
```html
<!doctype html>
<html>
  <script>
...
## File: `licenses/license.openai_node.txt`
```
                                 Apache License
                           Version 2.0, January 2004
                        http://www.apache.org/licenses/
...
## File: `scripts/gh_deploy_site.sh`
```bash
#!/bin/bash
set -euxo pipefail
...
## File: `scripts/local_deploy_site.sh`
```bash
#!/bin/bash
set -euxo pipefail
...
## File: `scripts/serve_mlc_llm_dist.sh`
```bash
#!/bin/bash
# This file prepares all the necessary dependencies for the web build.
set -euxo pipefail
...
## File: `site/assets/css/hero.scss`
```scss
---
---
...
## File: `src/openai_api_protocols/index.ts`
```typescript
/**
 * The input to OpenAI API, directly adopted from openai-node with small tweaks:
 * https://github.com/openai/openai-node/blob/master/src/resources/chat/completions.ts
...
## File: `tests/function_calling.test.ts`
```typescript
/* eslint-disable no-useless-escape */
import {
  Role,
...
## File: `tests/generation_config.test.ts`
```typescript
import {
  GenerationConfig,
  postInitAndCheckGenerationConfigValues,
...
## File: `tests/multi_round_chat.test.ts`
```typescript
import { describe, expect, test } from "@jest/globals";
...
## File: `tests/openai_chat_completion.test.ts`
```typescript
/* eslint-disable no-useless-escape */
import {
...
## File: `tests/openai_completion.test.ts`
```typescript
...
## File: `tests/openai_embeddings.test.ts`
```typescript
import {
  EmbeddingInputEmptyError,
  EmbeddingUnsupportedEncodingFormatError,
...
## File: `tests/scripts/sanity_checks/package.json`
```json
{
  "name": "sanity_checks",
  "version": "0.1.0",
...
## File: `tests/scripts/sanity_checks/README.md`
```markdown
...
## File: `tests/scripts/sanity_checks/sanity_checks.html`
```html
<!doctype html>
<html lang="en">
  <head>
...
## File: `utils/vram_requirements/.gitignore`
```
src/app-config.js
```

## File: `utils/vram_requirements/package.json`
```json
{
...
## File: `utils/vram_requirements/README.md`
```markdown
### vRAM Requirements
...
## File: `utils/vram_requirements/src/gh-config.js`
```javascript
...
## File: `utils/vram_requirements/src/vram_requirements.html`
```html
<!DOCTYPE html>
<html>
<script>
