---
id: webgpu-claude-skill.git-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:32:46.108460
---

# KNOWLEDGE EXTRACT: webgpu-claude-skill.git
> **Extracted on:** 2026-03-30 13:14:22
> **Source:** webgpu-claude-skill.git
...
## File: `skills/webgpu-threejs-tsl/docs/compute-shaders.md`
```markdown
# TSL Compute Shaders
...
## File: `skills/webgpu-threejs-tsl/docs/core-concepts.md`
```markdown
# TSL Core Concepts
...
## File: `skills/webgpu-threejs-tsl/docs/device-loss.md`
```markdown
...
## File: `skills/webgpu-threejs-tsl/docs/materials.md`
```markdown
# TSL Node Materials
...
## File: `skills/webgpu-threejs-tsl/docs/post-processing.md`
```markdown
# TSL Post-Processing
...
## File: `skills/webgpu-threejs-tsl/docs/wgsl-integration.md`
```markdown
# WGSL Integration
