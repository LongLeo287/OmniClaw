---
id: jacob-bd-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:28:55.786007
---

# KNOWLEDGE EXTRACT: jacob-bd
> **Extracted on:** 2026-03-30 17:38:10
> **Source:** jacob-bd

---

## File: `notebooklm-cli.md`
```markdown
# 📦 jacob-bd/notebooklm-cli [🔖 PENDING/APPROVE]
...
## File: `notebooklm-mcp-cli.md`
```markdown
# 📦 jacob-bd/notebooklm-mcp-cli [⭐ ACTIVE]
🔗 https://github.com/jacob-bd/notebooklm-mcp-cli


## Meta
- **Stars:** ⭐ 3009 | **Forks:** 🍴 515
- **Language:** Python | **License:** MIT
...
> 🎉 **January 2026 — Major Update!** This project has been completely refactored to unify **NotebookLM-MCP** and **NotebookLM-CLI** into a single, powerful package. One install gives you both the CLI (`nlm`) and MCP server (`notebooklm-mcp`). See the [CLI Guide](CLI_GUIDE.md) and [MCP Guide](MCP_GUIDE.md) for full documentation.
...
- **[MCP Guide](MCP_GUIDE.md)** — All 35 MCP tools with examples
- **[Authentication](AUTHENTICATION.md)** — Setup and troubleshooting
- **[API Reference](API_REFERENCE.md)** — Internal API docs for contributors
...
For detailed instructions and troubleshooting, see **[docs/AUTHENTICATION.md](AUTHENTICATION.md)**.
...
📚 **Full configuration details:** [MCP Guide](MCP_GUIDE.md) — Server options, environment variables, HTTP transport, multi-user setup, and context window management.
