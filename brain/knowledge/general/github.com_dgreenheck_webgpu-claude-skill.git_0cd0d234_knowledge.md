---
id: github.com-dgreenheck-webgpu-claude-skill.git-0cd0
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:44.483441
---

# KNOWLEDGE EXTRACT: github.com_dgreenheck_webgpu-claude-skill.git_0cd0d234
> **Extracted on:** 2026-04-01 16:13:38
> **Source:** D:/LongLeo/AI OS CORP/AI OS/core/security/QUARANTINE/KI-BATCH-20260331205007524970/github.com_dgreenheck_webgpu-claude-skill.git_0cd0d234
...
- [Three.js TSL Documentation](https://threejs.org/brain/knowledge/docs_legacy/pages/TSL.html)
...
## File: `skills/webgpu-threejs-tsl/REFERENCE.md`
```markdown
# TSL Quick Reference
...
- [TSL Docs](https://threejs.org/brain/knowledge/docs_legacy/pages/TSL.html)
- [WebGPU Examples](https://github.com/mrdoob/three.js/tree/master/examples)
- [Three.js Docs](https://threejs.org/brain/knowledge/docs_legacy/)
- [WebGPU Best Practices - Device Loss](https://toji.dev/webgpu-best-practices/device-loss)
```

## File: `skills/webgpu-threejs-tsl/SKILL.md`
```markdown
---
...
### Documentation
- `brain/knowledge/docs_legacy/core-concepts.md` - Types, operators, uniforms, control flow
- `brain/knowledge/docs_legacy/materials.md` - Node materials and all properties
- `brain/knowledge/docs_legacy/compute-shaders.md` - GPU compute with instanced arrays
- `brain/knowledge/docs_legacy/post-processing.md` - Built-in and custom effects
- `brain/knowledge/docs_legacy/wgsl-integration.md` - Custom WGSL functions
- `brain/knowledge/docs_legacy/device-loss.md` - Handling GPU device loss and recovery
...
## File: `skills/webgpu-threejs-tsl/brain/knowledge/docs_legacy/compute-shaders.md`
```markdown
# TSL Compute Shaders
...
## File: `skills/webgpu-threejs-tsl/brain/knowledge/docs_legacy/core-concepts.md`
```markdown
# TSL Core Concepts
...
## File: `skills/webgpu-threejs-tsl/brain/knowledge/docs_legacy/device-loss.md`
```markdown
...
## File: `skills/webgpu-threejs-tsl/brain/knowledge/docs_legacy/materials.md`
```markdown
# TSL Node Materials
...
## File: `skills/webgpu-threejs-tsl/brain/knowledge/docs_legacy/post-processing.md`
```markdown
# TSL Post-Processing
...
## File: `skills/webgpu-threejs-tsl/brain/knowledge/docs_legacy/wgsl-integration.md`
```markdown
# WGSL Integration
...
## File: `skills/webgpu-threejs-tsl/examples/basic-setup.js`
```javascript
/**
...
## File: `skills/webgpu-threejs-tsl/examples/custom-material.js`
```javascript
/**
...
## File: `skills/webgpu-threejs-tsl/examples/earth-shader.js`
```javascript
/**
...
## File: `skills/webgpu-threejs-tsl/examples/particle-system.js`
```javascript
/**
...
## File: `skills/webgpu-threejs-tsl/examples/post-processing.js`
```javascript
/**
...
## File: `skills/webgpu-threejs-tsl/templates/compute-shader.js`
```javascript
/**
...
## File: `skills/webgpu-threejs-tsl/templates/webgpu-project.js`
```javascript
/**
