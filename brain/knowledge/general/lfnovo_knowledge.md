...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:29:04.057107
---

# KNOWLEDGE EXTRACT: lfnovo
> **Extracted on:** 2026-03-30 17:40:16
> **Source:** lfnovo

---

## File: `open-notebook.md`
```markdown
# 📦 lfnovo/open-notebook [⭐ ACTIVE]
🔗 https://github.com/lfnovo/open-notebook
🌐 https://www.open-notebook.ai

## Meta
- **Stars:** ⭐ 21467 | **Forks:** 🍴 2448
...
- **[From Source (Developers)](from-source.md)** - For development and contributions
- **[Complete Installation Guide](../INDEX.md)** - All deployment scenarios
...
- **🆘 Troubleshooting**: [5-minute troubleshooting guide](../bmad_repo/quick-fixes.md)
...
### Getting Started
- **[📖 Introduction](../INDEX.md)** - Learn what Open Notebook offers
- **[⚡ Quick Start](quick-start.md)** - Get up and running in 5 minutes
- **[🔧 Installation](../INDEX.md)** - Comprehensive setup guide
- **[🎯 Your First Notebook](docs/0-START-HERE/first-notebook.md)** - Step-by-step tutorial

### User Guide
- **[📱 Interface Overview](interface-overview.md)** - Understanding the layout
- **[📚 Notebooks](../../../vault/archives/archive_legacy/transformers/docs/source/en/notebooks.md)** - Organizing your research
- **[📄 Sources](../../../core/security/QUARANTINE/vetted/repos/claude_code_templates/cli_tool/components/skills/ai_research/ml_paper_writing/references/sources.md)** - Managing content types
- **[📝 Notes](../../../vault/archives/archive_legacy/aider/aider/website/docs/leaderboards/notes.md)** - Creating and managing notes
- **[💬 Chat](../../../vault/archives/archive_legacy/hindsight/hindsight-docs/docs/sdks/integrations/chat.md)** - AI conversations
- **[🔍 Search](search.md)** - Finding information

### Advanced Topics
- **[🎙️ Podcast Generation](docs/2-CORE-CONCEPTS/podcasts.md)** - Create professional podcasts
- **[🔧 Content Transformations](transformations.md)** - Customize content processing
- **[🤖 AI Models](../INDEX.md)** - AI model configuration
- **[🔌 MCP Integration](mcp-integration.md)** - Connect with Claude Desktop, VS Code and other MCP clients
- **[🔧 REST API Reference](api-reference.md)** - Complete API documentation
- **[🔐 Security](../bmad_repo/SECURITY.md)** - Password protection and privacy
...
- **New to Open Notebook?** Start with our [Getting Started Guide](../INDEX.md)
- **Need installation help?** Check our [Installation Guide](../INDEX.md)
- **Want to see it in action?** Try our [Quick Start Tutorial](quick-start.md)
