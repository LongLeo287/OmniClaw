...
| `open-notebook` | ✅ ACTIVE | Tier 2 | — | Nova primary tool. Port 8502/5055. KHÔNG Changes:. |
| `open-notebooklm` | ✅ ACTIVE | Tier 2 | — | Audio podcast gen. KHÔNG Changes:. |
...
| `langextract` | ✅ ACTIVE | Tier 2 | — | Active, KHÔNG Changes:. check monthly. |
...
| `all-agentic-architectures` | 📚 REFERENCE | — | — | **Verdict:** REFERENCE. 17 Architecture Agent (Reflection, ReAct, PEV, Blackboard, ToT, Metacognitive...). KI: `brain/knowledge/notes/KI-AGENT-ARCHITECTURES-01.md` |
...
| `MiniMax-MCP` | 🔖 DEFER → Phase 5 | Tier 2 | Safe | **Verdict:** DEFER. MiniMax API bridge — integrate khi LLM Router cần MiniMax model (Example: video/audio gen). |
