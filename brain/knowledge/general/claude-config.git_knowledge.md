---
id: claude-config.git-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:03.353146
---

# KNOWLEDGE EXTRACT: claude-config.git
> **Extracted on:** 2026-03-30 13:12:44
> **Source:** claude-config.git
...
See [.claude/rules/testing.md](../bmad_repo/testing.md) for testing conventions.
...
For detailed workflows, see [.claude/rules/workflows.md](workflows.md).
...
My agent configuration for [Claude Code](https://docs.anthropic.com/en/brain/knowledge/docs_legacy/claude-code) and Codex.
...
- [Claude Code docs](https://docs.anthropic.com/en/brain/knowledge/docs_legacy/claude-code)
...
| -------------------------------------------------------------------- | --------------------------------------------------------- |
| [references/commands.md](../bmad_repo/commands.md)                     | Full command reference with all options                   |
...
| [references/session-management.md](../../../vault/archives/archive_legacy/agent-browser/skills/agent-browser/references/session-management.md) | Parallel sessions, state persistence, concurrent scraping |
| [references/authentication.md](AUTHENTICATION.md)         | Login flows, OAuth, 2FA handling, state reuse             |
| [references/video-recording.md](../../../vault/archives/archive_legacy/agent-browser/skills/agent-browser/references/video-recording.md)       | Recording workflows for debugging and documentation       |
| [references/profiling.md](../../../core/security/QUARANTINE/vetted/repos/claude_code_templates/cli_tool/components/skills/ai_research/mlops_tensorboard/references/profiling.md)                   | Chrome DevTools profiling for performance analysis        |
| [references/proxy-support.md](../../../vault/archives/archive_legacy/agent-browser/skills/agent-browser/references/proxy-support.md)           | Proxy configuration, geo-testing, rotating proxies        |
...
Lightpanda does not support `--extension`, `--profile`, `--state`, or `--allow-file-access`. Install Lightpanda from https://lightpanda.io/brain/knowledge/docs_legacy/open-source/installation.
...
For detailed API docs, see `node_modules/bun-types/brain/knowledge/docs_legacy/**.md`.
```
...
Agent prompt example:
- "Paste `CWS_REFRESH_TOKEN` now. I will only place it in local secret vault/CI secrets."
...
`https://developer.chrome.com/brain/knowledge/docs_legacy/webstore/using-api`
- Publish endpoint:
`https://developer.chrome.com/brain/knowledge/docs_legacy/webstore/publish`
- OAuth Playground:
`https://developers.google.com/oauthplayground/`
- API enablement page:
`https://console.cloud.google.com/apis/library/chromewebstore.googleapis.com`
...
**Reference:** [project-setup.md](../../../vault/archives/archive_legacy/claude-code-templates/cli-tool/templates/common/.claude/commands/project-setup.md)
...
## File: `skills/electron-wrapper/references/build-and-distribute.md`
```markdown
# Build & Distribution
...
## File: `skills/electron-wrapper/references/main-process.md`
```markdown
# Main Process
...
## File: `skills/electron-wrapper/references/project-setup.md`
```markdown
# Project Setup
...
## File: `skills/electron-wrapper/references/web-adaptation.md`
```markdown
# Web App Adaptation
...
## File: `skills/skill-creator/references/output-patterns.md`
```markdown
# Output Patterns
...
## File: `skills/tdd/deep-modules.md`
```markdown
# Deep Modules
...
## File: `skills/tdd/interface-design.md`
```markdown
...
## File: `skills/tdd/refactoring.md`
```markdown
# Refactor Candidates
...
See [tests.md](../../../core/security/QUARANTINE/incoming/repos/AutoGPT/docs/platform/contributing/tests.md) for examples and [mocking.md](mocking.md) for mocking guidelines.
