...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:31:04.927131
---

# Department: qa_testing
# qa-gate.md â€” QA Gate Protocol for OmniClaw Corp
...
**Outcome:**
- ALL 5 PASS â†’ Write `[QA PASS] TASK_ID` to subagents/mq/qa_pass.md â†’ delivery
- ANY FAIL â†’ Write `[QA FAIL] TASK_ID: reason` to subagents/mq/qa_reject.md
  â†’ Engineering worker receives failure note â†’ fixes â†’ re-submits
...
```
Check A â€” COMPLETENESS: all requirements addressed?
Check B â€” COMPLIANCE: no policy violations?
```

**Outcome:**
- PASS â†’ approved
- FAIL â†’ send back with specific feedback
