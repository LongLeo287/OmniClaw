...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:05.724538
---
...
### Components (adopt in OmniClaw)
| Component | Description | OmniClaw Mapping |
|-----------|-------------|---------------|
...
```
**OmniClaw Action:** Create `hooks/` folder with PowerShell hook scripts.
...
**OmniClaw Relevance:** This directly upgrades our `smart_memory` + `cosmic_memory` skills. Install immediately.

---

## Best Practices for Claude Code (OmniClaw Operations)
