...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:05.747212
---
...
## ðŸ› ï¸ Foundation knowledge (Claude Code is required to read before coding)
...
- [ ] **Report:** Write the result "Satisfactorily Completed" to `brain/memory/blackboard.json` (change `handoff_trigger` to `DONE`).

> âš  **CLAUDE CODE CLI ATTENTION:** Absolutely do not delete any System files. After completing the code, remember to report back to the Master.
