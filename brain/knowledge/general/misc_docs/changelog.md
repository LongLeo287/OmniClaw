...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:00.628338
---
...
* **Documentation Reference Pages** — Added `brain/knowledge/docs_legacy/reference/agents.md`, `commands.md`, and `testing.md` (PR #1525)
...
- **Site-Relative Links**: Converted 217 links to repo-relative format (/brain/knowledge/docs_legacy/path/file.md)
...
`brain/knowledge/docs_legacy/modules/core/`:
...
- **From**: `brain/knowledge/docs_legacy/` root
...
`brain/knowledge/docs_legacy/bmad-core-concepts/`:
...
- **Removed Redundant Docs**: Eliminated duplicate documentation in `src/modules/bmb/brain/knowledge/docs_legacy/`
...
- Previous: `brain/knowledge/docs_legacy/`
