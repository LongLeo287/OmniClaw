...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:32:46.782575
---

# Worker Rules â€” OmniClaw
# Authority: Tier 3 | Updated: 2026-03-17
# Applied to: all Worker Agents in all departments

RULE WRK-01: TASK PULL â€” NEVER PUSH
...
RULE WRK-03: RECEIPT AFTER EVERY TASK
  ...
  after every completed task â€” SUCCESS or FAILURE.
  No task is "done" without a receipt.

RULE WRK-04: TWO-STRIKE RULE
  Attempt 1 fails â†’ modify approach, retry once.
  Attempt 2 fails â†’ STOP. Write L1 escalation to subagents/mq/<dept>_escalation.md.
...
RULE WRK-07: LLM TIER COMPLIANCE
  ...
  Economy tasks save cost â€” use MiniMax / GPT-4o-mini for simple tasks.

RULE WRK-08: CLARIFY BEFORE START
  If task acceptance criteria are ambiguous â†’ write clarification request L1 BEFORE starting.
  Starting ambiguous tasks wastes tokens and produces wrong outputs.

RULE WRK-09: QA FLAG
  If your output requires QA review â†’ set qa_required: true in receipt.
