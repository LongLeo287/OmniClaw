...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:29:00.429917
---
...
## Concepts Áp Dụng Cho OmniClaw
- **program.md = lightweight skill** → Mỗi task OmniClaw nên có 1 instruction file rõ ràng
- **Time budget** → OmniClaw tasks nên có timeout/SLA definition
- **Single metric** → Mỗi OmniClaw experiment cần 1 measurable outcome
...
Apply: Định nghĩa SLA/timeout cho OmniClaw tasks
```
