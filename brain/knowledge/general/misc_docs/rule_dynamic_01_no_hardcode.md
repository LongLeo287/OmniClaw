...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:31:10.142277
---
...
| Corp state | snapshot in boot file | `brain/memory/blackboard.json` (live) |
...
- Use RELATIVE paths: `brain/memory/blackboard.json` âœ…
