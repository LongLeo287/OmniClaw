---
id: auto-execute-commands
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:18:51.606821
---
...
| **CLI VERIFY** | `omniclaw.py status`, `omniclaw.py corp start`, health check | ✅ Tự chạy để verify |
...
**Category rules:**
- Corp Cycle → commands `omniclaw.py corp *`
...
- ✅ Update `blackboard.json` nếu command Changes: system state
- ✅ Notify CEO với bảng tóm tắt: command → Result:

---

## Example: THỰC TẾ (2026-03-25)
...
python omniclaw.py corp start               → CLI VERIFY → tự chạy
```
...
4. Test `omniclaw.py status` → output verified ✅
5. Báo Result: cho CEO
