...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:29:06.861303
---
...
## ðŸ¢ 2. The Workforce Directory (Ordered by ID)
...
## ðŸ”— 3. Inter-Departmental Connections (Workflows)

### ðŸ“¥ 1. Intake Workflow (CIV Gate)
`External URL -> [CIV Intake] -> [Strix Security] -> [Knowledge Index]`

### ðŸ§ª 2. Development Workflow (QA Gate)
`Engineering -> [QA Testing] -> [Content Review] -> [Production]`

### ðŸ’° 3. Financial Workflow (Cost Gate)
