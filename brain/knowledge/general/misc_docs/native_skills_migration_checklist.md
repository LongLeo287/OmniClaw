...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:29:11.074744
---
...
- [x] Confirm Gemini CLI native skills path is `.gemini/skills/{skill-name}/SKILL.md` (per [geminicli.com/brain/knowledge/docs_legacy/cli/skills](https://geminicli.com/brain/knowledge/docs_legacy/cli/skills/))
