...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:28:53.406742
---
...
const memories = await retrieveMemories(prompt, { user_id: "borat", mem0API_KEY='[REDACTED_API_KEY]' });
...
await addMemories(
    ...
    { user_id: "borat", mem0API_KEY='[REDACTED_API_KEY]' }
);
```
