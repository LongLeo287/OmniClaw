---
id: claude-boris-12-tips-12-feb-26
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:02.412566
---
...
Full wildcard syntax is supported — e.g., `Bash(bun run *)` or `Edit(/brain/knowledge/docs_legacy/**)`.
...
- [Claude Code Terminal Setup Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/terminal)
- [Claude Code Plugins & Discovery Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/discover-plugins)
- [Claude Code Sub-agents Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/sub-agents)
- [Claude Code Permissions Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/permissions)
- [Claude Code Sandbox Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/sandbox)
- [Claude Code Status Line Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/statusline)
- [Claude Code Keyboard Shortcuts Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/keybindings)
- [Claude Code Hooks Reference](https://code.claude.com/brain/knowledge/docs_legacy/en/hooks)
- [Claude Code Output Styles Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/output-styles)
- [Claude Code Settings Docs](https://code.claude.com/brain/knowledge/docs_legacy/en/settings)
