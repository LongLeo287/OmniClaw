...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:31:10.169256
---
...
|------|----------|-------------|
| All runtime secrets | `core/ops/secrets/MASTER.env` | YES |
| Local overrides | `.env` (root) | YES |
| Bridge token store | `brain/memory/vault_tokens.json` | YES |
| Keys directory | `core/ops/secrets/KEYS/` | YES |
| DPAPI backup | `core/ops/secrets/MASTER.env.dpapi` | YES |
...
$SecretsLoader = Join-Path $OMNICLAW_ROOT "core\ops\secrets\load-env.ps1"
...
IF EXIST "%OMNICLAW_ROOT%\core\ops\secrets\MASTER.env" (
    FOR /F "usebackq tokens=1,* delims==" %%A IN ("%OMNICLAW_ROOT%\core\ops\secrets\MASTER.env") DO (
...
ENV_FILE = r"D:\LongLeo\OmniClaw\AI OS\core\ops\secrets\MASTER.env"
...
```
.env
core/ops/secrets/MASTER.env
core/ops/secrets/*.dpapi
core/ops/secrets/KEYS/
