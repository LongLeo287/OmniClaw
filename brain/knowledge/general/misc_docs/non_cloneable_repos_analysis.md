...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:29:12.162321
---
...
### OmniClaw Learning Points
- **12-agent parallel execution** pattern — OmniClaw can adopt for large task decomposition
...
### OmniClaw Learning Points
- **Universal AI proxy pattern** — great for routing between providers in OmniClaw
...
- Useful for OmniClaw dashboard integration (running multiple agent terminals)
...
### OmniClaw Learning Points
- **Hardware-aware model selection** — OmniClaw can use this pattern for local LLM routing
- OpenClaw integration = OmniClaw direct compatibility
...
### OmniClaw Learning Points
- **35+ ready-to-use marketing skills** directly importable into OmniClaw skills/
- Pattern: skill category system (domain packs) = OmniClaw skills/domains/ structure
...
### OmniClaw Learning Points
- 8-level structure mirrors OmniClaw tier system (Tier 1 eager → Tier 3 manual)
- "THE SOUL CODE" = basis for `cognitive_reflector` + `cognitive_evolver` skills
- Multi-persona simulation = OmniClaw agent roster (AGENTS.md) pattern
...
### OmniClaw Learning Points
- **Role-based multi-agent system** = foundation for OmniClaw AGENTS.md
...
**OmniClaw Learning Points:**
- Clean Architecture layers = OmniClaw module organization pattern
...
*Extracted: 2026-03-16 | Method: GitHub raw README fetch | OmniClaw Knowledge Bank*
...
**Status in OmniClaw:** ✅ CLONED → plugins/antigravity-deck/ (already present from earlier scan)
...
**OmniClaw Integration:** → Add to Service Manager dashboard (Port 4000 default)  
...
**Status in OmniClaw:** ✅ CLONED → plugins/AstrBot/
...
**OmniClaw Role:** Alternative/complement to channels/ bridge module
...
**Status in OmniClaw:** ✅ CLONED → REMOTE/claws/gstack/  
**Key Points:** Garry Tan's exact Claude Code setup — 6 agents as CEO, Eng Manager, etc.  
**OmniClaw Role:** Skills/prompts for multi-agent orchestration patterns
...
**Status in OmniClaw:** ✅ CLONED → REMOTE/claws/antigravity-kit/  
**Key Points:** Book/docs at https://2026-03-15-antigravity-kit-book.vercel.app/ — 20 agents, 37 skills, multi-agent orchestration  
**OmniClaw Role:** SDK patterns for building Antigravity-native applications
...
**Status in OmniClaw:** ✅ CLONED → plugins/AntigravityManager/
...
**OmniClaw Role:** Manage multiple Antigravity accounts + API proxy (maps Claude ↔ Gemini)
...
**Status in OmniClaw:** ✅ CLONED → plugins/OpenViking/  
**Key Points:** Unified management of memory, resources, skills via filesystem paradigm. Has API server.  
**OmniClaw Role:** Context/memory DB layer for AI agents — complements knowledge/ directory
...
**Status in OmniClaw:** ✅ CLONED → plugins/open-claude-cowork/  
**Key Points:** Electron app with Composio integration (GitHub, Slack, Linear, etc.)  
**OmniClaw Role:** Claude task automation with 500+ SaaS connectors
...
**Status in OmniClaw:** ✅ CLONED → knowledge/repos/pm-skills/  
**Key Points:** Skills for discovery, strategy, execution, launch, growth phases  
**OmniClaw Role:** PM-focused skills to expand OmniClaw's product management capabilities
...
**Status in OmniClaw:** ✅ CLONED → knowledge/repos/awesome-agent-skills/  
**OmniClaw Role:** Skills repository — massive collection compatible with Antigravity
...
**OmniClaw Role:** Drop in any GitHub repo → interactive knowledge graph + AI chat about code
...
**Status in OmniClaw:** ✅ CLONED → knowledge/repos/hindsight/  
**OmniClaw Role:** Persistent cross-session learning memory for AI agents
...
**Status in OmniClaw:** ✅ CLONED → knowledge/repos/claude-openclaw-bridge/  
**OmniClaw Role:** Bridge Claude Code → OpenClaw; one-shot queries + persistent relay mode
...
**OmniClaw Value:** Core workflow methodology reference for multi-agent coding
...
**OmniClaw Value:** Full documentation for antigravity-kit plugin

### ByteRover Docs
**URL:** https://docs.byterover.dev/  
**Content:** Docs for ByteRover AI agents platform  
**OmniClaw Value:** Reference for agentic browsing capabilities
...
**OmniClaw Value:** Code comprehension patterns for AI code understanding
...
**OmniClaw Value:** Pattern for documenting OmniClaw's own event-driven architecture
...
**Clone decision:** Optional — media download utility, not core OmniClaw function  
**OmniClaw Value:** Media scraping capability if needed for content tasks
...
**OmniClaw Value:** LLM training patterns and fine-tuning techniques
...
**Clone decision:** No — macOS/iOS only, not relevant for Windows-based OmniClaw  
**OmniClaw Value:** Reference for SwiftUI + MCP integration patterns
...
**Status in OmniClaw:** ✅ CLONED → `knowledge\repos\learn-claude-code`  
**Key Points:**  
...
**OmniClaw Role:** Core reference for understanding Antigravity/Claude Code architecture. Invaluable for building new OmniClaw agent tools.
...
**Status in OmniClaw:** ✅ CLONED → `knowledge\repos\agentsview`  
...
**OmniClaw Role:** → Add to Service Manager. Monitor all your AI coding sessions in one place.
...
**Status in OmniClaw:** ✅ CLONED → `knowledge\repos\openchatbi`  
...
**OmniClaw Role:** If OmniClaw needs to query databases, this is the pattern to follow.
...
**OmniClaw Role:** Reference for designing beautiful terminal dashboards and TUI components in OmniClaw
...
**Status in OmniClaw:** CLONE → `knowledge\repos\temm1e`  
...
**OmniClaw Role:** Future reference for building persistent always-on AI agent daemons. Architecture pattern for production agent deployment.

---

## �� nagisanzenin Plugin Suite (3 plugins)
**Author:** nagisanzenin | **Status in OmniClaw:** ✅ CLONED → `knowledge\repos\nagisanzenin\`
...
- **OmniClaw Role:** Use to auto-generate new skills for OmniClaw skill registry
...
- **OmniClaw Role:** Reference for building production services with AI
...
- **OmniClaw Role:** Command patterns for autonomous SaaS delivery from OmniClaw
...
- Integration target: OmniClaw could display Warp notification webhooks in LobsterBoard
- Windows support is NOW available (was macOS-only previously)

**OmniClaw Role:** Reference product for OmniClaw terminal integration design. Not cloneable but essential knowledge for designing the OmniClaw dashboard and agent orchestration UI.
...
**Status in OmniClaw:** ✅ CLONED → `knowledge\repos\gsd-2`  
...
**OmniClaw Role:** ⭐ VERY RELEVANT — Architecture for long-running OmniClaw sessions with persistent context. Should be studied and incorporated into OmniClaw's agent loop design.
...
rows:
  ...
  - panes:
      - title: Logs
        command: tail -f logs/OMNICLAW.log
      - title: Shell
`
**OmniClaw Role:** Ideal for setting up the OmniClaw development environment as a one-command tmux workspace
...
**Status in OmniClaw:** ✅ CLONED → plugins\openclaw-command-center  
**Start:** 
...
**OmniClaw Role:** ⭐ ADD TO SERVICE MANAGER — Best OpenClaw-specific dashboard available. Complements LobsterBoard with OpenClaw-specific metrics.
...
**Status in OmniClaw:** ✅ CLONED → knowledge\repos\my-translator  
**Clone decision:** Analysis only — macOS/Apple Silicon app, not runnable on Windows  
**OmniClaw Role:** Pattern reference for building real-time speech translation in OmniClaw (future: Vietnamese voice commands)
...
**Status in OmniClaw:** ✅ CLONED → knowledge\repos\agent-teams-lite  
**Key Points:**
...
**OmniClaw Role:** Agent orchestration patterns for OmniClaw's multi-agent workflows. Study and adapt into OmniClaw's agent coordination system.
...
**Status in OmniClaw:** ✅ CLONED → `knowledge\repos\event-catalog\fieldtrip`  
...
**OmniClaw Role:** → Add to Service Manager. Extremely useful for exploring OmniClaw's own API schemas. Run against `knowledge/repos/` folder to map all schema relationships across 150+ ingested repos.
