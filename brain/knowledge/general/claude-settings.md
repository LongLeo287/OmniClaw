...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:05.246690
---
...
| `Write` | `Write(path pattern)` | `Write(*.md)`, `Write(./brain/knowledge/docs_legacy/**)` |
...
For the official hooks reference, see the [Claude Code Hooks Documentation](https://code.claude.com/brain/knowledge/docs_legacy/en/hooks).
...
- [Claude Code Settings Documentation](https://code.claude.com/brain/knowledge/docs_legacy/en/settings)
