---
id: github.com-waynesutton-convexskills-b76dde93-knowl
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:28:43.536295
---

# KNOWLEDGE EXTRACT: github.com_waynesutton_convexskills_b76dde93
> **Extracted on:** 2026-04-01 17:11:32
> **Source:** D:/LongLeo/AI OS CORP/AI OS/system/security/QUARANTINE/KI-BATCH-20260331205007525568/github.com_waynesutton_convexskills_b76dde93
...
See the Code Quality section in [convex-best-practices](../bmad_repo/SKILL.md) for setup instructions.
...
| Skill                                                                    | Description                                           |
| ------------------------------------------------------------------------ | ----------------------------------------------------- |
| [convex-best-practices](../bmad_repo/SKILL.md)           | Guidelines for building production-ready Convex apps  |
| [convex-functions](../bmad_repo/SKILL.md)                     | Writing queries, mutations, actions, and HTTP actions |
| [convex-realtime](../bmad_repo/SKILL.md)                       | Patterns for building reactive applications           |
| [convex-schema-validator](../bmad_repo/SKILL.md)       | Database schema definition and validation             |
| [convex-file-storage](../bmad_repo/SKILL.md)               | File upload, storage, and serving                     |
| [convex-agents](../bmad_repo/SKILL.md)                           | Building AI agents with Convex                        |
| [convex-cron-jobs](../bmad_repo/SKILL.md)                     | Scheduled functions and background tasks              |
| [convex-http-actions](../bmad_repo/SKILL.md)               | HTTP endpoints and webhook handling                   |
| [convex-migrations](../bmad_repo/SKILL.md)                   | Schema evolution and data migrations                  |
| [convex-security-check](../bmad_repo/SKILL.md)           | Quick security audit checklist                        |
| [convex-security-audit](../bmad_repo/SKILL.md)           | Deep security review patterns                         |
| [convex-component-authoring](../bmad_repo/SKILL.md) | Creating reusable Convex components                   |
...
| ------------------------------------------------------------ | -------------------------------------------- |
| [templates/CLAUDE.md](../../agents/CLAUDE.md)                   | Project context template for Convex projects |
...
| Document | Purpose |
|----------|---------|
| [AGENTS.md](../bmad_repo/agents.md) | Agent skills specification for AI coding agents |
...
|-------|-----------------|
| [convex-best-practices](../bmad_repo/SKILL.md) | Production patterns, error handling, OCC |
| [convex-functions](../bmad_repo/SKILL.md) | Queries, mutations, actions, HTTP actions |
| [convex-realtime](../bmad_repo/SKILL.md) | Subscriptions, optimistic updates |
| [convex-schema-validator](../bmad_repo/SKILL.md) | Schema definition, typing, validation |
| [convex-file-storage](../bmad_repo/SKILL.md) | Upload, storage, serving files |
| [convex-agents](../bmad_repo/SKILL.md) | AI agents with thread management |
| [convex-cron-jobs](../bmad_repo/SKILL.md) | Scheduled functions, background tasks |
| [convex-http-actions](../bmad_repo/SKILL.md) | HTTP endpoints, webhooks |
| [convex-migrations](../bmad_repo/SKILL.md) | Schema evolution, data migrations |
| [convex-security-check](../bmad_repo/SKILL.md) | Quick security audit checklist |
| [convex-security-audit](../bmad_repo/SKILL.md) | Deep security review patterns |
| [convex-component-authoring](../bmad_repo/SKILL.md) | Reusable Convex components |
...
## File: `skills/convex-file-storage/SKILL.md`
```markdown
---
...
## File: `skills/convex-file-storage/agents/openai.yaml`
```yaml
interface:
  icon_small: "./assets/small-logo.svg"
  icon_large: "./assets/large-logo.png"
...
See the Code Quality section in [convex-best-practices](../bmad_repo/SKILL.md) for linting setup.
