---
id: github.com-huggingface-skills-928195ec-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:20:07.995528
---

# KNOWLEDGE EXTRACT: github.com_huggingface_skills_928195ec
> **Extracted on:** 2026-04-01 15:41:13
> **Source:** D:/LongLeo/AI OS CORP/AI OS/system/security/QUARANTINE/KI-BATCH-20260331205007524686/github.com_huggingface_skills_928195ec
...
> [!TIP]
> If your agent doesn't support skills, you can use [`agents/AGENTS.md`](../../../.claude/skills/supabase-postgres-best-practices/AGENTS.md) directly as a fallback.
...
3. If your Codex setup still relies on `AGENTS.md`, you can use the generated [`agents/AGENTS.md`](../../../.claude/skills/supabase-postgres-best-practices/AGENTS.md) file in this repo as a fallback bundle of instructions.
...
|------|-------------|---------------|
| `hf-cli` | Execute Hugging Face Hub operations using the hf CLI. Download models/datasets, upload files, manage repos, and run cloud compute jobs. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-community-evals` | Add and manage evaluation results in Hugging Face model cards. Supports extracting eval tables from README content, importing scores from Artificial Analysis API, and running custom evaluations with vLLM/lighteval. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-datasets` | Explore, query, and extract data from any Hugging Face dataset using the Dataset Viewer REST API and npx tooling. Zero Python dependencies — covers split/config discovery, row pagination, text search, filtering, SQL via parquetlens, and dataset upload via CLI. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-gradio` | Build Gradio web UIs and demos in Python. Use when creating or editing Gradio apps, components, event listeners, layouts, or chatbots. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-jobs` | Run compute jobs on Hugging Face infrastructure. Execute Python scripts, manage scheduled jobs, and monitor job status. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-llm-trainer` | Train or fine-tune language models using TRL on Hugging Face Jobs infrastructure. Covers SFT, DPO, GRPO and reward modeling training methods, plus GGUF conversion for local deployment. Includes hardware selection, cost estimation, Trackio monitoring, and Hub persistence. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-paper-publisher` | Publish and manage research papers on Hugging Face Hub. Supports creating paper pages, linking papers to models/datasets, claiming authorship, and generating professional markdown-based research articles. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-papers` | Look up and read Hugging Face paper pages in markdown, and use the papers API for structured metadata like authors, linked models, datasets, Spaces, and media URLs when needed. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-trackio` | Track and visualize ML training experiments with Trackio. Log metrics via Python API and retrieve them via CLI. Supports real-time dashboards synced to HF Spaces. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `huggingface-vision-trainer` | Train and fine-tune object detection models (RTDETRv2, YOLOS, DETR and others) and image classification models (timm and transformers models — MobileNetV3, MobileViT, ResNet, ViT/DINOv3) using Transformers Trainer API on Hugging Face Jobs infrastructure or locally. Includes COCO dataset format support, Albumentations augmentation, mAP/mAR metrics, trackio tracking, hardware selection, and Hub persistence. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
| `transformers-js` | Run state-of-the-art machine learning models directly in JavaScript/TypeScript for NLP, computer vision, audio processing, and multimodal tasks. Works in Node.js and browsers with WebGPU/WASM using Hugging Face models. | [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) |
<!-- END_SKILLS_TABLE -->
...
## File: `apps/evals-leaderboard/app.py`
```python
#!/usr/bin/env python3
"""
...
## File: `apps/evals-leaderboard/collect_evals.py`
```python
#!/usr/bin/env python3
"""
...
## File: `apps/evals-leaderboard/requirements.txt`
```
gradio
requests
pyyaml
...
## File: `apps/hackers-leaderboard/README.md`
```markdown
---
...
## File: `apps/hackers-leaderboard/app.py`
```python
#!/usr/bin/env python3
"""
...
## File: `apps/hackers-leaderboard/collect_points.py`
```python
#!/usr/bin/env python3
"""
...
## File: `apps/hackers-leaderboard/requirements.txt`
```
gradio>=5.50.0
...
## File: `apps/quests/02_evaluate-hub-model.md`
```markdown
...
- [SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) — Full skill documentation
- [Example Usage](../../../core/security/QUARANTINE/vetted/repos/claude_code_templates/cli_tool/components/skills/scientific/paper_2_web/references/usage_examples.md) — Worked examples
- [Metric Mapping](../../hf-evaluation/examples/metric_mapping.json) — Standard metric types

```

## File: `apps/quests/03_publish-hub-dataset.md`
```markdown
...
## File: `apps/quests/04_sft-finetune-hub.md`
```markdown
...
## File: `hf-mcp/skills/hf-mcp/SKILL.md`
```markdown
---
name: hf-mcp
...
def generate_readme_table(skills: list[dict[str, str]]) -> str:
    ...
    for skill in skills:
        ...
        doc_link = f"[SKILL.md](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md)"
...
## File: `scripts/generate_cursor_plugin.py`
```python
#!/usr/bin/env -S uv run
# /// script
# requires-python = ">=3.10"
...
## File: `scripts/run_skills_help.py`
```python
#!/usr/bin/env python3
"""
...
## File: `skills/huggingface-community-evals/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-community-evals/examples/.env.example`
```
...
## File: `skills/huggingface-community-evals/examples/USAGE_EXAMPLES.md`
```markdown
# Usage Examples
...
## File: `skills/huggingface-community-evals/scripts/inspect_eval_uv.py`
```python
# /// script
# requires-python = ">=3.10"
# dependencies = [
...
## File: `skills/huggingface-community-evals/scripts/inspect_vllm_uv.py`
```python
# /// script
# requires-python = ">=3.10"
# dependencies = [
...
## File: `skills/huggingface-community-evals/scripts/lighteval_vllm_uv.py`
```python
# /// script
# requires-python = ">=3.10"
# dependencies = [
...
## File: `skills/huggingface-datasets/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-gradio/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-gradio/examples.md`
```markdown
...
## File: `skills/huggingface-jobs/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-jobs/index.html`
```html
<!DOCTYPE html>
<html lang="en">
<head>
...
## File: `skills/huggingface-jobs/references/hardware_guide.md`
```markdown
...
## File: `skills/huggingface-jobs/references/hub_saving.md`
```markdown
...
## File: `skills/huggingface-jobs/references/token_usage.md`
```markdown
...
## File: `skills/huggingface-jobs/references/troubleshooting.md`
```markdown
...
## File: `skills/huggingface-jobs/scripts/cot-self-instruct.py`
```python
# /// script
# requires-python = ">=3.10"
# dependencies = [
...
## File: `skills/huggingface-jobs/scripts/finepdfs-stats.py`
```python
# /// script
...
## File: `skills/huggingface-jobs/scripts/generate-responses.py`
```python
# /// script
# requires-python = ">=3.10"
# dependencies = [
...
## File: `skills/huggingface-llm-trainer/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-llm-trainer/references/gguf_conversion.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/hardware_guide.md`
```markdown
# Hardware Selection Guide
...
## File: `skills/huggingface-llm-trainer/references/hub_saving.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/local_training_macos.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/reliability_principles.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/trackio_guide.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/training_methods.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/training_patterns.md`
```markdown
# Common Training Patterns
...
## File: `skills/huggingface-llm-trainer/references/troubleshooting.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/references/unsloth.md`
```markdown
...
## File: `skills/huggingface-llm-trainer/scripts/convert_to_gguf.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-llm-trainer/scripts/dataset_inspector.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-llm-trainer/scripts/estimate_cost.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-llm-trainer/scripts/train_dpo_example.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-llm-trainer/scripts/train_grpo_example.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-llm-trainer/scripts/train_sft_example.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-llm-trainer/scripts/unsloth_sft_example.py`
```python
# /// script
# requires-python = ">=3.10"
# dependencies = [
...
## File: `skills/huggingface-paper-publisher/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-paper-publisher/examples/example_usage.md`
```markdown
...
## File: `skills/huggingface-paper-publisher/references/quick_reference.md`
```markdown
...
- [Full documentation](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md)
- [Usage examples](../../../core/security/QUARANTINE/vetted/repos/claude_code_templates/cli_tool/components/skills/scientific/markitdown/assets/example_usage.md)
- [HF Paper Pages](https://huggingface.co/papers)
- [tfrere's template](https://huggingface.co/spaces/tfrere/research-article-template)
```

## File: `skills/huggingface-paper-publisher/scripts/paper_manager.py`
```python
#!/usr/bin/env -S uv run
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-paper-publisher/templates/arxiv.md`
```markdown
---
title: {{TITLE}}
authors: {{AUTHORS}}
...
## File: `skills/huggingface-paper-publisher/templates/ml-report.md`
```markdown
---
title: {{TITLE}}
authors: {{AUTHORS}}
...
## File: `skills/huggingface-paper-publisher/templates/modern.md`
```markdown
---
title: {{TITLE}}
authors: {{AUTHORS}}
...
## File: `skills/huggingface-paper-publisher/templates/standard.md`
```markdown
---
title: {{TITLE}}
authors: {{AUTHORS}}
...
## File: `skills/huggingface-papers/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-trackio/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-trackio/references/alerts.md`
```markdown
# Trackio Alerts
...
## File: `skills/huggingface-trackio/references/logging_metrics.md`
```markdown
...
## File: `skills/huggingface-trackio/references/retrieving_metrics.md`
```markdown
...
- **Complete CLI documentation**: See [docs/source/cli_commands.md](../../../core/security/QUARANTINE/vetted/repos/claude_code_templates/cli_tool/components/skills/development/netlify_deploy/references/cli_commands.md)
- **API and MCP Server**: See [docs/source/api_mcp_server.md](docs/source/api_mcp_server.md)

```

## File: `skills/huggingface-vision-trainer/SKILL.md`
```markdown
---
...
## File: `skills/huggingface-vision-trainer/references/finetune_sam2_trainer.md`
```markdown
...
## File: `skills/huggingface-vision-trainer/references/hub_saving.md`
```markdown
...
## File: `skills/huggingface-vision-trainer/references/image_classification_training_notebook.md`
```markdown
...
## File: `skills/huggingface-vision-trainer/references/object_detection_training_notebook.md`
```markdown
...
## File: `skills/huggingface-vision-trainer/references/reliability_principles.md`
```markdown
# Reliability Principles for Training Jobs
...
## File: `skills/huggingface-vision-trainer/references/timm_trainer.md`
```markdown
...
## File: `skills/huggingface-vision-trainer/scripts/dataset_inspector.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-vision-trainer/scripts/estimate_cost.py`
```python
#!/usr/bin/env python3
# /// script
# requires-python = ">=3.10"
...
## File: `skills/huggingface-vision-trainer/scripts/image_classification_training.py`
```python
# /// script
# dependencies = [
#     "transformers>=5.2.0",
...
## File: `skills/huggingface-vision-trainer/scripts/object_detection_training.py`
```python
# /// script
# dependencies = [
#     "transformers>=5.2.0",
...
## File: `skills/huggingface-vision-trainer/scripts/sam_segmentation_training.py`
```python
# /// script
# dependencies = [
#     "transformers>=5.2.0",
...
## File: `skills/transformers-js/SKILL.md`
```markdown
---
...
**⚠️ Memory Management:** All pipelines must be disposed with `pipe.dispose()` when finished to prevent memory leaks. See examples in [Code Examples](../claude_bp_repo/examples.md) for cleanup patterns across different environments.
...
**→ [Pipeline Options - Progress Callback](../../../vault/archives/archive_legacy/docling/docs/reference/pipeline_options.md#progress-callback)**
...
4. **Cache Models**: Models are cached automatically (see **[Caching Reference](../../../core/security/QUARANTINE/vetted/repos/trivy/docs/guide/configuration/cache.md)** for details on browser Cache API, Node.js filesystem cache, and custom implementations)
...
For detailed patterns (React cleanup, servers, browser), see **[Code Examples](../claude_bp_repo/examples.md)**
...
### This Skill
- **[Pipeline Options](../../../vault/archives/archive_legacy/docling/docs/reference/pipeline_options.md)** - Configure `pipeline()` with `progress_callback`, `device`, `dtype`, etc.
- **[Configuration Reference](configuration.md)** - Global `env` configuration for caching and model loading
- **[Caching Reference](../../../core/security/QUARANTINE/vetted/repos/trivy/docs/guide/configuration/cache.md)** - Browser Cache API, Node.js filesystem cache, and custom cache implementations
...
- **[Code Examples](../claude_bp_repo/examples.md)** - Real-world implementations for different runtimes
...
## File: `skills/transformers-js/references/CACHE.md`
```markdown
# Caching Reference
...
- [Configuration Reference](./CONFIGURATION.md)
- [Pipeline Options](../../../vault/archives/archive_legacy/docling/docs/reference/pipeline_options.md)
```

## File: `skills/transformers-js/references/CONFIGURATION.md`
```markdown
...
See **[Caching Reference](../../../core/security/QUARANTINE/vetted/repos/trivy/docs/guide/configuration/cache.md)**
...
- **[Caching Reference](../../../core/security/QUARANTINE/vetted/repos/trivy/docs/guide/configuration/cache.md)** - Comprehensive caching guide (browser, Node.js, custom implementations)
- [Pipeline Options](../../../vault/archives/archive_legacy/docling/docs/reference/pipeline_options.md) - Configure pipeline loading with `progress_callback`, `device`, `dtype`, etc.
...
- [Main Skill Guide](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) - Getting started and common usage
```

## File: `skills/transformers-js/references/EXAMPLES.md`
```markdown
...
## File: `skills/transformers-js/references/MODEL_ARCHITECTURES.md`
```markdown
...
## File: `skills/transformers-js/references/PIPELINE_OPTIONS.md`
```markdown
...
- [Main Skill Guide](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) - Getting started with Transformers.js
...
## File: `skills/transformers-js/references/TEXT_GENERATION.md`
```markdown
...
- [Pipeline Options](../../../vault/archives/archive_legacy/docling/docs/reference/pipeline_options.md) - Configure pipeline loading
...
- [Main Skill Guide](../../../.claude/skills/supabase-postgres-best-practices/SKILL.md) - Getting started guide
```
