...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:28:52.305318
---

# KNOWLEDGE EXTRACT: HKUDS
...
## File: `ClawTeam.md`
```markdown
# 📦 HKUDS/ClawTeam [🔖 PENDING/APPROVE]
🔗 https://github.com/HKUDS/ClawTeam


## Meta
- **Stars:** ⭐ 3714 | **Forks:** 🍴 511
...
Full compatibility with [Claude Code](https://claude.ai/claude-code), [Codex](https://openai.com/codex), [OpenClaw](https://github.com/openclaw/openclaw), [nanobot](https://github.com/HKUDS/nanobot), [Cursor](https://cursor.com), and any CLI agent.&nbsp;&nbsp;[**中文文档**](README_CN.md) | [**한국어**](../../../core/security/QUARANTINE/vetted/repos/ClawTeam/README_KR.md)
...
## File: `ClawWork.md`
```markdown
# 📦 HKUDS/ClawWork [⭐ ACTIVE]
🔗 https://github.com/HKUDS/ClawWork


## Meta
- **Stars:** ⭐ 7646 | **Forks:** 🍴 987
- **Language:** Python | **License:** MIT
...
> **Full setup instructions**: See [clawmode_integration/README.md](../../../README.md)
...
## File: `FastCode.md`
```markdown
# 📦 HKUDS/FastCode [🔖 PENDING/APPROVE]
🔗 https://github.com/HKUDS/FastCode
🌐 https://arxiv.org/abs/2603.01012

## Meta
- **Stars:** ⭐ 2075 | **Forks:** 🍴 244
...
FastCode introduces a three-phase framework that transfo
```
...
## File: `LightRAG.md`
```markdown
# 📦 HKUDS/LightRAG [⭐ ACTIVE]
🔗 https://github.com/HKUDS/LightRAG
🌐 https://arxiv.org/abs/2410.05779

## Meta
- **Stars:** ⭐ 30702 | **Forks:** 🍴 4392
- **Language:** Python | **License:** MIT
- **Last updated:** 2026-03-27
...
* For more information about LightRAG Server, please refer to [LightRAG Server](../../../README.md).
...
export NEO4J_PASSWORD='[REDACTED_PASSWORD]'
...
The LightRAG Server is designed to provide Web UI and API support.  **For more information about LightRAG Server, please refer to [LightRAG Server](../../../README.md).**

## Graph Visualization

The LightRAG Server offers a comprehensive knowledge graph visualization feature. It supports various gravity layouts, node queries, subgraph filtering, and more. **For more information about LightRAG Server, please refer to [LightRAG Server](../../../README.md).**
...
**RAGAS** (Retrieval Augmented Generation Assessment) is a framework for reference-free evaluation of RAG systems using LLMs. There is an evaluation script based on RAGAS. For detailed information, please refer to [RAGAS-based Evaluation Framework](README_EVALUASTION_RAGAS.md).
...
## File: `nanobot.md`
```markdown
# 📦 HKUDS/nanobot [🔖 PENDING/APPROVE]
🔗 https://github.com/HKUDS/nanobot


## Meta
- **Stars:** ⭐ 36451 | **Forks:** 🍴 6247
- **Language:** Python | **License:** MIT
- **Last updated:** 2026-03-26
- **Status trong AI OS:** 🔖 PENDING/APPROVE
