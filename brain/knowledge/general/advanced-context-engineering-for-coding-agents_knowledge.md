---
id: advanced-context-engineering-for-coding-agents-kno
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:18:39.910677
---

# KNOWLEDGE EXTRACT: advanced-context-engineering-for-coding-agents
> **Extracted on:** 2026-03-30 13:15:29
> **Source:** advanced-context-engineering-for-coding-agents
...
Subagents are another way to manage context, and generic subagents (i.e. not [custom](https://docs.anthropic.com/en/brain/knowledge/docs_legacy/claude-code/sub-agents) ones) have been a feature of claude code and many coding CLIs since the early days.
