...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:31:05.211069
---

laude# QUARANTINE ZONE — OmniClaw External Repo Isolation

> ⚠️ **WARNING:** This folder is an **ISOLATION ZONE**.
> All external repositories MUST be cloned here FIRST before any content enters the OmniClaw ecosystem.
...
4. **Only clean files** may leave this folder and enter OmniClaw
...
& "D:\APP\OmniClaw\skills\security_shield\vet_repo.ps1" -RepoPath "D:\APP\QUARANTINE\repo-name" -Verbose

# Step 4: After PASS — copy ONLY needed files
# Example:
Copy-Item "D:\APP\QUARANTINE\repo-name\some-skill\" -Destination "D:\APP\OmniClaw\skills\" -Recurse
...
- **Full Protocol:** `D:\APP\OmniClaw\rules\clone_security_protocol.md`
- **Knowledge:** `D:\APP\OmniClaw\knowledge\repo_vetting_knowledge.md`
- **Vet Script:** `D:\APP\OmniClaw\skills\security_shield\vet_repo.ps1`
