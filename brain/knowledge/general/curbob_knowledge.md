...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:16.104695
---

# KNOWLEDGE EXTRACT: curbob
> **Extracted on:** 2026-03-30 17:35:41
> **Source:** curbob

---

## File: `LobsterBoard.md`
```markdown
# 📦 curbob/LobsterBoard [⭐ ACTIVE]
...
```bash
sudo cat > /etc/systemd/core/lobsterboard.service << 'EOF'
[Unit]
