...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:18:40.163241
---
...
```
Create: ecosystem/workforce/agents/proposals/AGENT-PROPOSAL-<timestamp>-<domain>.md
...
1. AGENT.md — Full agent specification
   Path: ecosystem/workforce/agents/<agent-id>/AGENT.md
   Template: ecosystem/workforce/agents/_template/AGENT.md
   Required sections:
...
- [ ] `ecosystem/workforce/agents/<agent-id>/AGENT.md` — created from template, all sections filled
