---
id: payloadcms-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:29:19.398940
---

# KNOWLEDGE EXTRACT: payloadcms
> **Extracted on:** 2026-03-30 17:50:50
> **Source:** payloadcms
...
## File: `payload.md`
```markdown
# 📦 payloadcms/payload [🔖 PENDING]
🔗 https://github.com/payloadcms/payload
🌐 https://payloadcms.com

## Meta
- **Stars:** ⭐ 41455 | **Forks:** 🍴 3510
...
**If you're new to Payload, you should start with the website template** (`pnpx create-payload-app@latest -t website`). It shows how to do _everything_
```
