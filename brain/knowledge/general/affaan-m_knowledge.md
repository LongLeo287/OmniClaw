---
id: affaan-m-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:18:40.077895
---

# KNOWLEDGE EXTRACT: affaan-m
> **Extracted on:** 2026-03-30 17:29:02
> **Source:** affaan-m

---

## File: `everything-claude-code.md`
```markdown
# 📦 affaan-m/everything-claude-code [⭐ ACTIVE]
🔗 https://github.com/affaan-m/everything-claude-code
🌐 https://ecc.tools

## Meta
- **Stars:** ⭐ 110948 | **Forks:** 🍴 14467
...
## README (FULL)
```
**Language:** English | [Português (Brasil)](../../../README.md) | [简体中文](README.zh-CN.md) | [繁體中文](../../../README.md) | [日本語](../../../README.md) | [한국어](../../../README.md)
 [Türkçe](../../../README.md)
...
[**English**](README.md) | [Português (Brasil)](../../../README.md) | [简体中文](README.zh-CN.md) | [繁體中文](../../../README.md) | [日本語](../../../README.md) | [한국어](../../../README.md)
 | [Türkçe](../../../README.md)
...
> **Note:** The Claude Code plugin system does not support distributing `rules` via plugins ([upstream limitation](https://code.claude.com/brain/knowledge/docs_legacy/en/plugins-reference)). You need to install rules manually:
>
> ```bash
> # Clone the repo first
> git clone https://github.com/affaan-m/everything-claude-code.git
...
See [`rules/README.md`](../../../README.md) for installation and structure details.
...
Official references:
- [Claude Code LLM gateway docs](https://docs.anthropic.com/en/brain/knowledge/docs_legacy/claude-code/llm-gateway)
- [Claude Code model configuration docs](https://docs.anthropic.com/en/brain/knowledge/docs_legacy/claude-code/model-config)
...
- **Antigravity**: Tightly integrated setup for workflows, skills, and flattened rules in `.agent/`. See [Antigravity Guide](../../../vault/archives/archive_legacy/everything-claude-code/docs/ANTIGRAVITY-GUIDE.md).
...
Hitting daily limits? See the **[Token Optimization Guide](../../../vault/archives/archive_legacy/everything-claude-code/docs/token-optimization.md)** for recommended settings and workflow tips.
...
[**Become a Sponsor**](https://github.com/sponsors/affaan-m) | [Sponsor Tiers](../../../core/security/QUARANTINE/vetted/repos/everything_claude_code/SPONSORS.md) | [Sponsorship Program](../../../core/security/QUARANTINE/vetted/repos/everything_claude_code/SPONSORING.md)
...
- **Security Guide:** [Security Guide](../../../vault/archives/archive_legacy/everything-claude-code/the-security-guide.md) | [Thread](https://x.com/affaanmustafa/status/2033263813387223421)
