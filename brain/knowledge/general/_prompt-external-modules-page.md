...
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:32:48.066220
---
...
Create a reference documentation page at `brain/knowledge/docs_legacy/reference/modules.md` that lists all official external BMad modules with descriptions and links.
...
Create `brain/knowledge/docs_legacy/reference/modules.md` following the project's Reference Catalog structure (see `brain/knowledge/docs_legacy/_STYLE_GUIDE.md`):
...
## Style
use @brain/knowledge/docs_legacy/_STYLE_GUIDE.md
...
- `brain/knowledge/docs_legacy/reference/agents.md`
- `brain/knowledge/docs_legacy/reference/commands.md`
- `brain/knowledge/docs_legacy/reference/testing.md`
