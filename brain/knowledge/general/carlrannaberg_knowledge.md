---
id: carlrannaberg-knowledge
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:19:00.435018
---

# KNOWLEDGE EXTRACT: carlrannaberg
> **Extracted on:** 2026-03-30 17:31:16
> **Source:** carlrannaberg

---

## File: `claudekit.md`
```markdown
# 📦 carlrannaberg/claudekit [⭐ ACTIVE]
...
[Codebase map guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/codebase-map.md)
...
[Spec workflow guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/spec-workflow.md)
...
[Checkpoint guide →](checkpoint.md)
...
[Hook profiling guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/hook-profiling.md)
...
[Thinking level guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/thinking-level.md)
...
[Session hook control guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/session-hook-control.md)
...
See the [external LLMs guide](../../../vault/archives/archive_legacy/claudekit/docs/guides/using-prompts-with-external-llms.md) for examples with Claude Code, Amp, Gemini CLI, and others.
...
[View all commands →](../bmad_repo/commands.md)
...
[Self-review guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/self-review.md)
...
[Hook configuration →](../../../core/security/QUARANTINE/vetted/repos/claude_code_templates/cli_tool/components/skills/development/react_dev/references/hooks.md) | [Profiling guide →](../../../vault/archives/archive_legacy/claudekit/docs/guides/hook-profiling.md)
...
- `oracle` - Deep debugging and complex problem analysis ([requires setup](../../../core/security/QUARANTINE/vetted/repos/openclaw/docs/install/oracle.md))
...
[View all agents →](../../../core/security/QUARANTINE/vetted/repos/openclaw/docs/tools/subagents.md)
...
See the [File Guard Guide](../../../vault/archives/archive_legacy/claudekit/docs/guides/file-guard.md) for detailed configuration and best practices.
...
- **Documentation**: [Full docs](brain/knowledge/docs_legacy/)
