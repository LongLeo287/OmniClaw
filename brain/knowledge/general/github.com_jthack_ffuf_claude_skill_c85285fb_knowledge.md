---
id: github.com-jthack-ffuf-claude-skill-c85285fb-knowl
type: document
owner: OHD
tags: [auto-healed]
healed_at: 2026-04-02T20:20:16.945216
---

# KNOWLEDGE EXTRACT: github.com_jthack_ffuf_claude_skill_c85285fb
> **Extracted on:** 2026-04-01 15:46:37
> **Source:** D:/LongLeo/AI OS CORP/AI OS/system/security/QUARANTINE/KI-BATCH-20260331205007524761/github.com_jthack_ffuf_claude_skill_c85285fb
...
## File: `ffuf-skill/ffuf_helper.py`
```python
#!/usr/bin/env python3
"""
...
## File: `ffuf-skill/resources/REQUEST_TEMPLATES.md`
```markdown
...
## File: `ffuf-skill/resources/WORDLISTS.md`
```markdown
