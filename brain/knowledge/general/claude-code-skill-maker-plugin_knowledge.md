# Knowledge Dump for claude-code-skill-maker-plugin
...
## File: _GIT_INGEST.md
```
# OmniClaw Repo Plow: CIV_FETCHED_claude-code-skill-maker-plugin_141347
...
{
  "name": "skill-maker",
  "description": "Creates new Claude Code skills and plugins end-to-end: interviews on the idea, writes SKILL.md, packages as plugin, creates GitHub repo, and adds to your marketplace",
  "version": "1.0.0",
  "author": {
    "name": "Quan Duong"
  },
  "license": "MIT",
  "keywords": ["skill", "plugin", "marketplace", "scaffold", "generator", "meta"]
}
