...
We have provided the crowdsourcing templates we used on mechanical turk, along with example inputs in `scripts/crowdworking_templates`. You mig
... [TRUNCATED]
```
...
### File: scripts\training\train_text_generation.py
```py
import os
