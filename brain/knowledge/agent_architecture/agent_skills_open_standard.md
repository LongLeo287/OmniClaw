...
> ⚡ **OmniClaw đang implement standard này** — `skills/` và `plugins/` trong OmniClaw follow spec này.
...
## OmniClaw Implementation vs. Spec

OmniClaw đang implement standard này với một số extensions:

| Spec | OmniClaw Implementation |
|------|---------------------|
| `SKILL.md` | ✅ Dùng đúng |
...
| OpenAI Codex | ✅ Native |
| Antigravity (OmniClaw) | ✅ Via OmniClaw implementation |
