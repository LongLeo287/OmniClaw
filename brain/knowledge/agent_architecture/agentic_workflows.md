...
**OmniClaw translation:**
- `orchestrator_pro` = Supervisor
- Specialist agents = subagents
- `brain/memory/blackboard.json` = LangGraph state
...
When ingesting agency-agents personalities into OmniClaw:
...
3. Add OmniClaw-specific fields:
...
**OmniClaw translation:** These map to Cowork Session Templates in `cowork/COWORK_PROTOCOL.md`
