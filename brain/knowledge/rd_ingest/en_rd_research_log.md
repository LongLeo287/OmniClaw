...
## PURPOSE
This log tracks all research ingested into OmniClaw Corp from the R&D channel.
The research-agent summarizes after each paper/model review.
The data-collector-agent logs each source that is ingested.
