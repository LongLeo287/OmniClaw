...
func TestUserService_Create(t *testing.T) {
    tests := []struct {
        ...
        {
            name: "valid user",
            req:  CreateUserRequest{Name: "Alice", Email: "alice@example.com", PASSWORD='[REDACTED_PASSWORD]'},
        ...
        },
        {
            ...
            req:  CreateUserRequest{Name: "Alice", Email: "taken@example.com", PASSWORD='[REDACTED_PASSWORD]'},
            setup: func(m *MockUserRepo) {
