# OmniClaw Corp — TinyLoRA Fine-Tuning Plan
...
Tận dụng TinyLoRA (13 parameters, RL-based) để fine-tune từng department agent trong OmniClaw Corp, tăng chất lượng reasoning mà không tăng infrastructure cost.
...
Source: Existing OmniClaw workflows + synthetic generation
```
...
= Full OmniClaw Corp agent layer với domain reasoning
```
...
- [ ] Create dataset generation pipeline từ OmniClaw Corp workflows
