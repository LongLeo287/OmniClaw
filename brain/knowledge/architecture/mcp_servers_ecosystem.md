...
- Perfect cho OmniClaw persistent memory layer
...
## Key Actionable Patterns cho OmniClaw

### Pattern 1: MCP trong OmniClaw context
OmniClaw hiện có `mcp/config.json` — có thể add thêm MCP servers:
```json
{
  "mcpServers": {
...
### Pattern 2: MCP servers phù hợp nhất cho OmniClaw
