---
id: eventstorming-glossary-cheat-sheet
type: knowledge
owner: OA_Triage
---
...
Thanks to all [existing and future contributors](https://github.com/ddd-crew/eventstorming-glossary-cheat-sheet/graphs/contributors) and to the following individuals who have all cont
... [TRUNCATED]
```
