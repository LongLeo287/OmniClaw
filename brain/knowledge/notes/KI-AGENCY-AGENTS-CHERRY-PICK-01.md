---
id: ki-agency-agents-cherry-pick-01
type: document
owner: SYSTEM
tags: [auto-healed]
healed_at: 2026-04-03T22:46:22.491053
---

# Knowledge Note: Agency Agents — Cherry-Picked Skills for OmniClaw
...
directly cherry-pick the ones that fill gaps in OmniClaw Corp's agent roster.

**Gap Analysis — What OmniClaw Agents LACK vs agency-agents:**

| Division | Gap in OmniClaw | agency-agents Template to Cherry-Pick |
|----------|-------------|--------------------------------------|
...
**Gap filled:** OmniClaw QA team reviews output but no dedicated code review agent in Engineering dept.
...
**Gap filled:** OmniClaw has SRE role but no formalized Incident Management workflow.
...
**Gap filled:** OmniClaw has MCP tools but no agent specialized in BUILDING new MCP servers.
...
**Gap filled:** OmniClaw needs an agent that maps ALL paths through a system before code is written.
...
**Gap filled:** AEO/GEO — making OmniClaw Corp visible in ChatGPT/Claude/Gemini answers.
**Action:** Import into `corp/departments/marketing/` as new worker.

---

## Key Philosophy Extracted (Apply to All OmniClaw Agents)
...
**Apply this to OmniClaw Worker Prompts:** Each WORKER_PROMPT.md should have a "Success Metrics" section listing measurable acceptance criteria. Currently missing in most depts.
...
4. Adapt: Replace LangChain/Claude-specific references with OmniClaw patterns
...
*Do NOT run agency-agents install scripts (they target ~/.claude/agents/ not OmniClaw Corp structure)*
*Cherry-pick TEMPLATES ONLY — adapt to OmniClaw format, not copy-paste verbatim.*
