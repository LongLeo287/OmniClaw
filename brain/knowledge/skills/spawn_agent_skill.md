...
> ⚡ **Trực tiếp liên quan đến OmniClaw** — đây là skill giải quyết limitation của Antigravity environment hiện tại.
...
$OMNICLAW_ROOT\skills\spawn-agent\SKILL.md
```
...
## Liên quan đến OmniClaw Skill System
...
**Next step cho OmniClaw:**
Clone skill này vào `skills/spawn-agent/` và adapt delegation templates cho OmniClaw context.
