...
# Luôn được bơm vào memory khi khởi động. Đây là "bộ não gốc" của OmniClaw Bot.
...
- **omniclaw_bot** — Telegram proxy (chính là bạn!)
...
- `repos/clawwork` — OmniClaw workflows cho OpenClaw
