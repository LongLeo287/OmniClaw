...
WATCHLIST_REPOS = [
  ...
  ("chatdev",          "ChatDev",                 "RESEARCH",  ["ai-ml","multi-agent"],       "rd",              [],                           "https://github.com/OpenBMB/ChatDev",              "25k", "Multi-agent software development simulation — 70+ agents play software company roles", "Pure simulation, ChatGLM-focused. Study role-based multi-agent design. OmniClaw already has agency-agents which is superior.", False, False),
  ("qwen-agent",       "Qwen Agent Framework",    "REFERENCE", ["ai-ml","llm"],               "rd, engineering", ["llm_router"],               "https://github.com/QwenLM/Qwen-Agent",            "5k",  "Official Qwen model agent framework. Tool-use, memory, CodeInterpreter, MCP client.", "Good reference for Qwen tool-call format. OmniClaw uses Claude but Qwen API available as fallback.", True, False),
  ("oh-my-openagent",  "Oh My OpenAgent",         "RESEARCH",  ["ai-ml","cli"],               "rd",              [],                           "https://github.com/code-yeongyu/oh-my-openagent", "200", "OpenAgent CLI toolkit for agent orchestration", "Research only — superseded by claude-octopus in OmniClaw", False, False),
  ("auto-accept-agent","Auto Accept Agent",        "TOOL",      ["ai-ml","automation"],        "engineering",     ["skill_generator"],          "https://github.com/Munkhin/auto-accept-agent",    "500", "Auto-accepts Antigravity permission prompts — runs in background while coding", "COMPATIBLE — directly useful for OmniClaw + Antigravity. Saves manual effort on permission popups.", True, True),
  ...
  ("astrbot",          "AstrBot",                 "TOOL",      ["bots","multi-channel"],      "operations",      ["corp_orchestrator"],        "https://github.com/AstrBotDevs/AstrBot",          "5k",  "Multi-platform AI bot: Telegram, Discord, WeChat, QQ. Plugin system. Supports OpenAI/Claude.", "COMPATIBLE — OmniClaw already runs AstrBot as a service. This is the source repo — study for plugins and updates.", True, False),
  ...
  ("spawn-agent",      "Spawn Agent",             "REFERENCE", ["ai-ml","agent-delegation"],  "engineering",     ["skill_generator"],          "https://github.com/khanhbkqt/spawn-agent",        "100", "Antigravity subagent delegation pattern — spawn subtasks to child agents", "Good pattern for OmniClaw agent-auto-create workflow. Study for spawn-from-parent patterns.", True, False),

  # ── RAG / MEMORY ─────────────────────────────────────────────────────
  ("llama-index",      "LlamaIndex",              "REFERENCE", ["ai-ml","rag"],               "engineering, rd", ["knowledge_navigator"],      "https://github.com/run-llama/llama_index",        "37k", "Comprehensive data framework for LLM apps. 300+ integrations. RAG, agents, workflows.", "REFERENCE — OmniClaw uses LightRAG+GraphRAG+mem0 for RAG. LlamaIndex too heavy to add. Use docs as reference for custom connector patterns.", True, False),
  ...
  ("ollamaMQ",         "Ollama Message Queue",    "TOOL",      ["ai-ml","llm","queue"],       "it_infra",        ["llm_router"],               "https://github.com/Chleba/ollamaMQ",              "200", "Message queue for Ollama — batch requests, prioritisation, async inference", "COMPATIBLE — pairs with Ollama :11434 in OmniClaw. Useful when multiple agents need LLM simultaneously.", True, False),
  ...
  ("awesome-ddd",      "Awesome DDD",             "REFERENCE", ["architecture","ddd"],        "engineering",     ["architect_agent"],          "https://github.com/heynickc/awesome-ddd",         "6k",  "Curated resources for Domain-Driven Design. Books, talks, libs, examples.", "REFERENCE — good foundation for OmniClaw microservice architecture. Study for dept/agent boundary design.", True, False),
  ...
  ("ddd-hexagonal",    "DDD Hexagonal CQRS ES",   "REFERENCE", ["architecture","cqrs"],       "engineering",     ["architect_agent"],          "https://github.com/bitloops/ddd-hexagonal-cqrs-es-eda", "1k","Complete DDD: Hexagonal + CQRS + Event Sourcing + EDA in TypeScript", "Advanced architecture reference for OmniClaw event-driven design.", True, False),
  ("domain-hexagon",   "Domain-Driven Hexagon",   "REFERENCE", ["architecture","ddd"],        "engineering",     ["architect_agent"],          "https://github.com/Sairyss/domain-driven-hexagon", "9k", "Best practices: DDD, Hexagonal Architecture, Clean Architecture. TypeScript.", "REFERENCE — architectural bible. Study for OmniClaw refactoring.", True, False),
  ...
  ("diginext",         "Diginext",                "REFERENCE", ["devops","deploy"],           "it_infra",        ["devops_agent"],             "https://github.com/digitopvn/diginext",           "200", "Vietnamese-built deployment platform: Docker, K8s, CI/CD, domain management.", "REFERENCE — interesting for OmniClaw IaC deployment. Vietnamese product.", True, False),
  ...
  ("tunnelto",         "TunnelTo",                "TOOL",      ["networking","tunnel"],       "it_infra",        ["devops_agent"],             "https://github.com/agrinman/tunnelto",            "4k",  "Expose local HTTP/HTTPS server to internet via tunnels. Rust binary. Self-hostable.", "USEFUL for OmniClaw dev — expose ClawTask :7474 or APIs for external webhooks (n8n, Telegram).", True, False),
  ("nport",            "NPort",                   "TOOL",      ["networking","proxy"],        "it_infra",        ["devops_agent"],             "https://github.com/tuanngocptn/nport",            "200", "Port forwarding and NAT traversal tool. Vietnamese-built.", "TOOL — useful for exposing OmniClaw services. Lightweight alternative to tunnelto.", True, False),
  ("llm-finetuning",   "LLM Finetuning",         "REFERENCE", ["ai-ml","finetune"],          "rd",              [],                           "https://github.com/ashishpatel26/LLM-Finetuning",  "8k", "Comprehensive PEFT/LoRA fine-tuning guide for all major LLMs", "REFERENCE — future OmniClaw model customization. Already ingested in previous session.", False, False),

  # ── CLI / TOOLS / UTILITIES ───────────────────────────────────────────
  ("qsv",              "QSV (CSV Swiss Knife)",   "TOOL",      ["data","csv"],                "engineering",     ["knowledge_navigator"],      "https://github.com/dathere/qsv",                  "3k",  "Blazing-fast CSV processing: 130+ commands. Rust binary. Replaces csvkit + pandas for simple ops.", "TOOL — useful for OmniClaw data pipelines. Install: download binary from releases.", True, False),
  ("dasel",            "Dasel",                   "TOOL",      ["data","cli"],                "engineering",     [],                           "https://github.com/tomwright/dasel",              "5k",  "Query/update JSON/YAML/TOML/CSV/XML with single tool. Like jq but multi-format.", "TOOL — useful in OmniClaw scripts for config manipulation. Install: `go install` or binary.", True, False),
  ("croc",             "Croc File Transfer",      "TOOL",      ["networking","file-transfer"],"it_infra",        [],                           "https://github.com/schollz/croc",                 "28k", "Secure peer-to-peer file transfer. End-to-end encrypted. Code-relay based.", "TOOL — simple and useful for transferring OmniClaw data between machines.", True, False),
  ("grex",             "Grex Regex Generator",    "TOOL",      ["dev-tooling","regex"],       "engineering",     [],                           "https://github.com/pemistahl/grex",               "7k",  "Generate regex patterns from examples. CLI and Python/Rust library.", "TOOL — useful in OmniClaw scripts for pattern matching. pip install grex.", True, False),
  ...
  # ── ANDROID / MEDIA ──────────────────────────────────────────────────
  ("smarttube",        "SmartTube",               "REFERENCE", ["media","android-tv"],        "operations",      [],                           "https://github.com/yuliskov/SmartTube",            "20k", "Ad-free YouTube client for Android TV / Chromecast. No Google account needed.", "REFERENCE — not directly usable in OmniClaw operations but useful consumer tool reference.", False, False),
  ("tiktok-dl",        "TikTok Downloader",       "TOOL",      ["media","download"],          "operations",      ["content_analyst"],          "https://github.com/JoeanAmier/TikTokDownloader",  "24k", "Bulk TikTok video/image/audio downloader. Watermark-free. 24k★.", "TOOL — could be useful for content pipeline if OmniClaw does media analysis. pip installable.", True, False),
  ("metube",           "MeTube",                  "TOOL",      ["media","download"],          "operations",      ["content_analyst"],          "https://github.com/alexta69/metube",              "8k",  "Self-hosted web UI for yt-dlp. Download videos from YouTube, TikTok, etc.", "TOOL — Docker self-hosted. Useful if OmniClaw processes video content.", True, False),
  ("vieneu-tts",       "VieNeu TTS",              "TOOL",      ["ai-ml","tts","vietnamese"],  "rd, operations",  ["content_analyst"],          "https://github.com/pnnbao97/VieNeu-TTS",          "200", "Vietnamese TTS model — natural Vietnamese speech synthesis. Local inference.", "TOOL — VERY RELEVANT for OmniClaw if needing Vietnamese voice output. Local, no API needed.", True, True),
  ("qwen3-asr",        "Qwen3 ASR",               "RESEARCH",  ["ai-ml","asr"],               "rd",              [],                           "https://github.com/QwenLM/Qwen3-ASR",             "500", "Qwen3 speech recognition — automatic speech recognition Chinese/multilingual", "RESEARCH — not yet production. Monitor for future ASR pipeline in OmniClaw.", False, False),
  ...
  ("ticket-bot",       "Ticket Bot (Discord)",    "TOOL",      ["bots","discord"],            "operations",      ["corp_orchestrator"],        "https://github.com/Sayrix/Ticket-Bot",            "2k",  "Discord ticket/support bot. Embeds, categories, transcripts.", "TOOL — could integrate with OmniClaw notification bridge for Discord support tickets.", True, False),
  ...
  # ── UI / FRONTEND ────────────────────────────────────────────────────
  ("ktab",             "kTab New Tab",            "REFERENCE", ["ui","browser-ext"],          "engineering",     [],                           "https://github.com/dunkbing/ktab",                "400", "Custom new tab page with quick links, search, weather. Browser extension.", "REFERENCE — not relevant to OmniClaw operations directly.", False, False),
  ("blinko",           "Blinko Notes",            "TOOL",      ["knowledge","notes"],         "operations",      ["knowledge_navigator"],      "https://github.com/blinkospace/blinko",           "5k",  "AI-enhanced notes app: vector search, auto-tagging, multi-device sync. Self-hosted.", "TOOL — could serve as OmniClaw quick-capture feed. Self-hosted via Docker. Study for brain/knowledge integration.", True, False),
  ...
  # ── DATA / AI ENGINEERING ────────────────────────────────────────────
  ("springboot-bp",    "SpringBoot Best Practices","REFERENCE",["architecture","java"],       "engineering",     [],                           "https://github.com/mduongvandinh/springboot-best-practices", "500","Vietnamese-authored Spring Boot best practices guide", "REFERENCE — useful if OmniClaw builds Java microservices.", False, False),
  ("yt-analysis",      "YouTube Data Engineering","REFERENCE", ["data","analytics"],          "rd, finance",     ["insight_engine"],           "https://github.com/darshilparmar/dataengineering-youtube-analysis-project", "2k","Complete data engineering pipeline for YouTube analytics", "REFERENCE — good example pipeline for OmniClaw data processing.", True, False),
  ("llmfit",           "LLMFit",                  "RESEARCH",  ["ai-ml","finetune"],          "rd",              [],                           "https://github.com/AlexsJones/llmfit",            "200", "Lightweight LLM fine-tuning framework focused on resource efficiency", "RESEARCH — monitor for future OmniClaw model customization needs.", False, False),
  ...
  # ── PROMPTS / MISC ───────────────────────────────────────────────────
  ("prompts-chat",     "Prompts.chat",            "REFERENCE", ["ai-ml","prompts"],           "rd",              ["skill_generator"],          "https://github.com/f/prompts.chat",               "31k", "Curated ChatGPT prompt templates for 100+ roles and use cases", "REFERENCE — import best prompts into OmniClaw prompt_manager. Study for CEO/agent instruction templates.", True, False),
  ("lazada-api",       "Lazada Affiliate API",    "REFERENCE", ["e-commerce","api"],          "finance",         [],                           "https://github.com/arm64x/PHP-Lazada-Affiliate-API-Tool","50","PHP Lazada affiliate API implementation", "REFERENCE — if OmniClaw Corp has affiliate/e-commerce strategy.", False, False),
  ("rst-translation",  "RSTGameTranslation",      "REFERENCE", ["tools","translation"],       "operations",      [],                           "https://github.com/thanhkeke97/RSTGameTranslation","500","AI-powered game translation tool (WPF). Tesseract OCR + DeepL.", "REFERENCE — specialized tool, not OmniClaw relevant except as OCR reference.", False, False),
  ("uni-extract",      "UniExtract2",             "TOOL",      ["tools","extraction"],        "engineering",     [],                           "https://github.com/Bioruebe/UniExtract2",          "2k",  "Universal file extractor: 70+ formats. Windows GUI.", "TOOL — Windows native, useful for OmniClaw data ingestion from compressed packages.", True, False),
]
...
**OmniClaw Compatible:** {compat_str}
...
if propose_clone:
    ...
    with open(prop_file, "w", encoding="utf-8") as f:
        ...
        f.write("Repos classified as TOOL + Compatible OmniClaw from knowledge-ingest Phase 3.\n")
