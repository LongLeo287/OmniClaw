...
Architecture:
    Runs silently in the background. Polls storage/vault/DATA/ for new intake tickets.
        ...
        if crew_script.exists():
            ...
            try:
                subprocess.run([
                    ...
                    "system/security/QUARANTINE", "storage/vault/DATA", "system/automations/daemons"
                ], capture_output=True)
