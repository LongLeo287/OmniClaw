...
RENAMES = [
    ...
    ("system/automations/daemons/auto_sync_omniclaw.ps1", "auto_sync_omniclaw.ps1"),
    ("system/infra/cli/omniclaw.ps1", "omniclaw.ps1"),
    ("system/infra/mcp/servers/omniclaw-workspace", "omniclaw-workspace"),
    ("system/ops/omniclaw_orchestrator.py", "omniclaw_orchestrator.py"),
    ("system/ops/omniclaw_startup.py", "omniclaw_startup.py"),
    ("system/ops/scripts/omniclaw_code_polisher.py", "omniclaw_code_polisher.py"),
    ("system/ops/scripts/omniclaw_context_injector.py", "omniclaw_context_injector.py"),
    ("system/ops/scripts/omniclaw_deep_cleaner.py", "omniclaw_deep_cleaner.py"),
    ("system/ops/scripts/omniclaw_path_fixer.py", "omniclaw_path_fixer.py"),
    ("system/ops/scripts/omniclaw.py", "omniclaw.py"),
    ("system/ops/scripts/omniclaw_integrate.py", "omniclaw_integrate.py"),
    ("system/ops/scripts/omniclaw_start.py", "omniclaw_start.py"),
    ("system/ops/scripts/audit_omniclaw.py", "audit_omniclaw.py"),
    ("system/ops/tools/omniclaw.js", "omniclaw.js"),
    ("system/telemetry/logs/mcp-omniclaw-workspace.log", "mcp-omniclaw-workspace.log"),
]
