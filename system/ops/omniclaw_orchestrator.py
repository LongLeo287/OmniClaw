...
ROUTING_TABLE = {
    ...
    "support":       {"agent": "channel_agent",           "tier": 2, "dept": "Dept19/Support","skill": "channel_manager",        "fallback": "omniclaw_bot"},
    ...
    # ── COMMS & NOTIFICATIONS ─────────────────────────────────────────────────
    "comms":         {"agent": "channel_agent",           "tier": 2, "dept": "Dept19/Comms",  "skill": "channel_manager",        "fallback": "omniclaw_bot"},
    "notification":  {"agent": "channel_agent",           "tier": 2, "dept": "Dept19/Comms",  "skill": "channel_manager",        "fallback": "omniclaw_bot"},
    "telegram":      {"agent": "omniclaw_bot",                "tier": 1, "dept": "Gateway",       "skill": "channel_manager",        "fallback": "channel_agent"},
...
DEPARTMENTS = {
    ...
    "Dept19": {"name": "Support/Comms",       "head": "channel_agent",             "members": ["omniclaw_bot"]},
    ...
    "System": {"name": "System Core",         "head": "antigravity",               "members": ["orchestrator_pro","cognitive_reflector","archivist","omniclaw_bot","gcp_architect"]},
}
