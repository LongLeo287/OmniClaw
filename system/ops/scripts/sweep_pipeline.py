"""
active_repos_pipeline.py — Ingest SWEEP_MASTER_REPOS.txt qua đúng pipeline AI OS Corp
...
ACTIVE_REPOS_FILE   = Path(_AOS_ROOT) / "storage" / "vault" / "DATA" / "SWEEP_MASTER_REPOS.txt"
LOG_FILE            = Path(_AOS_ROOT) / "system" / "security" / "QUARANTINE" / "logs" / "intake_log.md"
PROGRESS_FILE       = Path(_AOS_ROOT) / "system" / "security" / "QUARANTINE" / "logs" / ".sweep_progress.json"
