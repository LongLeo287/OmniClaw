...
const REGISTRY_PATH = process.env.REGISTRY_PATH ||
  (process.env.AOS_ROOT || require('path').resolve(__dirname, '../../../../..')) + "/shared-context/SKILL_REGISTRY.json";
  ...
  try {
    ...
    if (name === "check_health") {
      ...
      for (const s of entries) {
        ...
        if (skillPath && !fs.existsSync(path.join((process.env.AOS_ROOT || require('path').resolve(__dirname, '../../../../..')) + "", skillPath, "SKILL.md"))) {
