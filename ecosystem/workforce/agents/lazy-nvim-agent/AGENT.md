# AGENT: Lazy Nvim Agent â€” Auto-Scaffolded Agent for lazy.nvim
...
**Memory file:** `corp/memory/agents/lazy-nvim-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-30T22:29:55.352115+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-30T22:29:55.352115+07:00",
  "version": "1.0"
}
```
...
*Lazy Nvim Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
