...
## 2. Linked Toolkit
- **Primary Core Skill**: [healer.md](../../../skills/healer.md)
- **Description**: Domain Capability File linked via OA Academy. Refer to the specific instructions within [healer.md](../../../skills/healer.md).
