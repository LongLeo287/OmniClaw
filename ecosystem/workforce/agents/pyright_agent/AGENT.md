# AGENT: Pyright Agent - Auto-Scaffolded Agent for pyright
...
*Pyright Agent - Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*