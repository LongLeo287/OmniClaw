...
## 2. Linked Toolkit
- **Primary Core Skill**: [SKILL_SPEC.md](../../../skills/SKILL_SPEC.md)
- **Description**: Domain Capability File linked via OA Academy. Refer to the specific instructions within [SKILL_SPEC.md](../../../skills/SKILL_SPEC.md).
