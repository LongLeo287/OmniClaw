# SKILL PROFILE: eventsourcing_agent
...
## 2. Linked Toolkit
- **Primary Core Skill**: [pos_event_sourcing_auditor.md](../../../skills/pos_event_sourcing_auditor.md)
- **Description**: Domain Capability File linked via OA Academy. Refer to the specific instructions within [pos_event_sourcing_auditor.md](../../../skills/pos_event_sourcing_auditor.md).
