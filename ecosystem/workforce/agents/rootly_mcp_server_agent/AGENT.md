# AGENT: Rootly Mcp Server Agent - Auto-Scaffolded Agent for Rootly-MCP-server
...
*Rootly Mcp Server Agent - Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*