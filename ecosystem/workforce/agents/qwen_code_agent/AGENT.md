# AGENT: Qwen Code Agent - Auto-Scaffolded Agent for qwen-code
...
**Memory file:** `corp/memory/agents/qwen-code-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-30T22:28:19.341586+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-30T22:28:19.341586+07:00",
  "version": "1.0"
}
```
...
*Qwen Code Agent - Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*