# AGENT: Tinyclaw Agent â€” Auto-Scaffolded Agent for tinyclaw
...
**Memory file:** `corp/memory/agents/tinyclaw-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-31T01:32:11.403140+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-31T01:32:11.403140+07:00",
  "version": "1.0"
}
```
...
*Tinyclaw Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
