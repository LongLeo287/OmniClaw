# AGENT: Hermes Agent Agent â€” Auto-Scaffolded Agent for hermes-agent
...
**Memory file:** `corp/memory/agents/hermes-agent-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-31T01:13:53.839532+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-31T01:13:53.839532+07:00",
  "version": "1.0"
}
```
...
*Hermes Agent Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
