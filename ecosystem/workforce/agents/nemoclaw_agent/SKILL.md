...
description: >
  ...
  and REVEAL.js-compatible output. Integrates with OmniClaw OS reporting pipeline.
version: 1.0.0
author: OmniClaw OS — Registry Dept 14
tier: 3
...
NemoClaw is the **visual communicator** of OmniClaw OS. It transforms complex
