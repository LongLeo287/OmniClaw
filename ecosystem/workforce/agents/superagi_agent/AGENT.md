# AGENT: Superagi Agent - Auto-Scaffolded Agent for SuperAGI
...
*Superagi Agent - Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*