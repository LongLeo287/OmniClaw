# AGENT: Homebrew Core Agent â€” Auto-Scaffolded Agent for homebrew-core
...
**Memory file:** `corp/memory/agents/homebrew-core-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-30T22:51:54.768196+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-30T22:51:54.768196+07:00",
  "version": "1.0"
}
```
...
*Homebrew Core Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
