# AGENT: Superagi Agent â€” Auto-Scaffolded Agent for SuperAGI
...
**Memory file:** `corp/memory/agents/superagi-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-30T22:45:10.926328+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-30T22:45:10.926328+07:00",
  "version": "1.0"
}
```
...
*Superagi Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
