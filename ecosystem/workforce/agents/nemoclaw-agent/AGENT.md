# AGENT: Nemoclaw Agent â€” Auto-Scaffolded Agent for NemoClaw
...
**Memory file:** `corp/memory/agents/nemoclaw-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-30T22:46:27.259538+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-30T22:46:27.259538+07:00",
  "version": "1.0"
}
```
...
*Nemoclaw Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
