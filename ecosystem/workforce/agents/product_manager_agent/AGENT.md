...
**Primary Function:**
Generate CEO proposals each cycle. Track OKRs. Monitor market signals. Run learning loop.
...
**Required Skills:**
`cognitive_reflector, reasoning_engine, web_intelligence, knowledge_enricher`
...
Memory file: `corp/memory/agents/product-manager-agent.md`
