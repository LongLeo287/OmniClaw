# AGENT: Claude Plugins Official Agent â€” Auto-Scaffolded Agent for claude-plugins-official
...
*Claude Plugins Official Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
