...
## 2. Linked Toolkit
- **Primary Core Skill**: [explore.md](../../../skills/explore.md)
- **Description**: Domain Capability File linked via OA Academy. Refer to the specific instructions within [explore.md](../../../skills/explore.md).
