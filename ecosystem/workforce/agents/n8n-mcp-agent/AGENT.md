# AGENT: N8N Mcp Agent â€” Auto-Scaffolded Agent for n8n-mcp
...
**Memory file:** `corp/memory/agents/n8n-mcp-agent.md`
...
```json
{
  ...
  "ceo_approved": true,
  "approved_at": "2026-03-31T01:36:40.000621+07:00",
  "strix_approved": true,
  "dept": "engineering",
  "dept_number": "2",
  "llm_tier": "economy",
  "autonomy": "supervised",
  "activation_date": "2026-03-31T01:36:40.000621+07:00",
  "version": "1.0"
}
```
...
*N8N Mcp Agent â€” Created by OmniClaw Corp agent-auto-create workflow. Supervised until first performance review.*
