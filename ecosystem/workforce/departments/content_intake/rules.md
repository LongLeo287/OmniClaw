...
Ã¢â€Ã¢â€â‚¬Ã¢â€â‚¬ vet_repo.ps1 Ã¢â€ Â Strix Security vetting script
```
...
(NÃ¡ÂºÂ¿cÃƒÂ³ fileÃƒÂ o referÃ¡ÂºÂ¿u $OMNICLAW_ROOT\QUARANTINE Ã¢â€ â€ Ã„â€˜ÃƒÂ³ isÃƒÂ  LEGACY PATH Ã¢â‚¬â€ WRONG)
...
| Plugins / scripts | `PLUGIN` | vet_repo.ps1 + GATE_SECURITY | Ã¢â€ â€ SKILL or PLUGIN or TOOL_SCRIPT |
...
- SKILL: `context_manager` Ã¢â‚¬â€ ticket management, staging file
...
- `knowledge_enricher` Ã¢â‚¬â€ detect signal from content patterns
...
- `corp/sops/VALUE_ASSESSMENT_ROUTING.md` Ã¢â‚¬â€ MANDATORY. Routing matrices.
