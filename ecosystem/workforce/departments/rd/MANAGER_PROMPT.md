...
Your team: research-agent, experiment-agent, pilot-agent, **data-collector-agent** (NEW — added 2026-03-18)
...
- Writes pilot report → submitted to Strategy as proposal
...
- Outputs raw data to: `knowledge/rd_ingest/` → research-agent picks up
- Runs: daily at 00:00 UTC + on-demand

## INNOVATION RULES
- R&D does NOT deploy to production — experiments only
...
Pilots running: [list] — [early results]
