# SKILL PROFILE: homebrew_core_agent
...
## 2. Linked Toolkit
- **Primary Core Skill**: [code-review-expert.md](../../../skills/code-review-expert.md)
- **Description**: Domain Capability File linked via OA Academy. Refer to the specific instructions within [code-review-expert.md](../../../skills/code-review-expert.md).
