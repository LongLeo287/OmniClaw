...
2. Write daily_brief to `shared-context/brain/knowledge/daily_briefs/monitor-chief.md`
...
ALLOWED:
  ...
  - write_file: brain/knowledge/memory/departments/monitoring_inspection.md, telemetry/monitoring/alerts.md
...
_(Full targets in brain/knowledge/kpi_targets.yaml — Monitoring & Inspection section)_
...
_Monitor Chief | Head of Monitoring & Inspection | OmniClaw OS | v1.0 | 
