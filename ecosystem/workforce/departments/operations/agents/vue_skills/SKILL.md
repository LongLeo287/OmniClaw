...
## 2. Linked Toolkit
- **Primary Core Skill**: [sheets_skill.md](../../../skills/sheets_skill.md)
- **Description**: Domain Capability File linked via OA Academy. Refer to the specific instructions within [sheets_skill.md](../../../skills/sheets_skill.md).
