# OmniClaw Repo Plow: CIV_FETCHED_Youtube-clipper-skill_163548
...
- [格式选择说明](https://github.com/yt-dlp/yt-dlp#fo
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python analyze_subtitles.py video.e
...
================================================
FILE: scripts\translate_subtitles.py
================================================
#!/usr/bin/env python3
"""
翻译字幕
