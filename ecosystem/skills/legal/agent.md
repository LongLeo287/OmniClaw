...
2. Write daily_brief to `shared-context/brain/knowledge/daily_briefs/legal.md`
...
ALLOWED:
  ...
  - write_file: brain/knowledge/memory/departments/legal.md, telemetry/receipts/gate_legal/
...
_(Full targets in brain/knowledge/kpi_targets.yaml — Legal section)_
...
_General Counsel | General Counsel / GATE_LEGAL Authority | OmniClaw OS | v1.0 | 
_Dept 12 — Legal_
