...
| --- | --- | --- |
| User Description RÕ flow + rules + I/O | Fast Track: xác nhận → sinh | 4 → 5 |
...
| User Description workflow ≥3 bước tách rời | System Mode: hệ thống skill | 1 → 2 → 3 → 4S → 5 |
...
📚 **Đọc Details:** `resources/composition_cookbook.md`, `resources/advanced_patterns.md`

**Khi nào:** User Description workflow ≥3 bước, mỗi bước có thể hoạt động độc lập.
...
📚 **Đọc Details:** `phases/phase1_interview.md`

Mục tiêu: Hiểu công việc + quy trình + quy tắc từ góc nhìn người dùng.

**Tóm tắt:**
1. ⚡ **Quick Mode** — nếu user đã Description đủ rõ → sinh skill trong 1 lượt
2. Mở đầu → Hỏi Description công việc
...
📚 **Đọc Details:** `phases/phase2_extract.md`
...
📚 **Đọc Details:** `phases/phase3_detect.md`
...
📚 **Đọc Details:** `phases/phase4_generate.md`
...
📚 **Đọc Details:** `phases/phase5_test.md`
...
📚 **Đọc Details:** `phases/phase6_eval.md`
...
📚 **Đọc Details:** `phases/phase7_iterate.md`
...
📚 **Đọc Details:** `phases/phase8_optimize.md`
...
> **AI:** "Description cho em công việc mà anh muốn AI tự động hóa đi."
>
