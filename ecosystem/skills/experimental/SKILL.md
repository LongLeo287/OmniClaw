...
description: Staging area for experimental and fetched skills. Supabase agent skills (FETCHED_gh_supabase_agent_skills_20260320) have been promoted to ecosystem/skills/domains/databases/supabase-agent-skills/. Staging area is now clear.
...
**Repo:** `ecosystem/skills/experimental`
...
**To process:**
```bash
# Review and promote to ecosystem/skills/domains/databases/
mv "ecosystem/skills/experimental/FETCHED_gh_supabase_agent_skills_20260320-092430" \
   "ecosystem/skills/domains/databases/supabase-agent-skills-v2"
