...
## Description
Skill này tận dụng kho tri thức `public-apis` để tìm kiếm các endpoint phục vụ cho việc tích hợp tính năng mới vào hệ thống mà không phải xây dựng từ số 0.
