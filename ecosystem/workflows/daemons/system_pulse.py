#!/usr/bin/env python3
"""
core/automations/daemons/system_pulse.py — OmniClaw System Health Pulse Checker (B5)
...
Usage:
  python core/automations/daemons/system_pulse.py           # One-shot
  python core/automations/daemons/system_pulse.py --loop    # Loop every 5 minutes
  python core/automations/daemons/system_pulse.py --quiet   # Only alert when there's an issue
"""
import sys
import os
import json
