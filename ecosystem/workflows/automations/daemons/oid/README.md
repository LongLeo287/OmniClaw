...
The **OmniClaw Ingestion Daemon (OID)** is the central data intake nervous system of OmniClaw Corp. It replaces fragmented, manual scripts with a robust, fully autonomous **8-Phase Pipeline**. 
...
- High-value code, Markdown, and documentation are extracted.
- Ignored: Bloatware (`node_modules`, `venv`, binary files).
...
$env:OMNICLAW_ROOT = "D:\LongLeo\OmniClaw\AI OS"
...
> *Documentation generated by Antigravity | OmniClaw Corp V3.1*
