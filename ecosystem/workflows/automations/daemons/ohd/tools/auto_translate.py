...
--------------------------------------------------------
PURPOSE:
  Scan all internally-authored scripts (.py, .bat, .ps1) under the system/ directory,
...
USAGE:
  python system/ops/scripts/auto_translate.py [--dry-run] [--verbose]
...
NOTES:
  - Only targets files in system/ (excludes third-party code in brain/, ecosystem/)
