...
| [`../brain/rules/OIW_INTAKE_STRICT_RULE.md`](../brain/rules/OIW_INTAKE_STRICT_RULE.md) | OIW rules (incl. Rule 20.4: Zero Registration Rights) |
| [`../brain/rules/GLOBAL_BLACKLIST.md`](../brain/rules/GLOBAL_BLACKLIST.md) | Active IOC blacklist (OHD enforcement) |
