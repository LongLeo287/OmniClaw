...
REPOS = [
    {
        ...
        "usage": "Agent memory layer — drop-in for all OmniClaw agents needing persistent context across sessions",
    ...
    },
    {
        ...
        "usage": "Advanced RAG for long-form, narrative-heavy OmniClaw Corpus — complements LightRAG",
    ...
    },
    {
        ...
        "usage": "MiniMax TTS alternative — local voice output for OmniClaw agents; multimodal understanding",
    ...
    },
    {
        ...
        "usage": "Design reference for OmniClaw agent architecture — learning resource for skill_generator agent",
        "install": "",
    },
    {
        "dir": "clawwork",
    ...
    },
    {
        ...
        "usage": "OmniClaw CLI LLM orchestration — wrap multiple LLM providers from shell scripts and cron jobs",
    ...
    },
    {
        ...
        "usage": "OmniClaw automation backbone — N8N receives external events and triggers AI agents via webhooks",
    ...
    },
    {
        ...
        "usage": "Web research automation for OmniClaw knowledge workers and web-intelligence pipelines",
    ...
    },
    {
        ...
        "usage": "Reference for OmniClaw infra decisions — MLOps, evaluation frameworks, prompt optimization",
        "install": "",
    },
    {
        ...
        "usage": "Onboarding guide for OmniClaw agents and developers using Claude Code (Antigravity)",
        "install": "",
    },
    {
        "dir": "trufflehog",
        ...
        "usage": "CI/CD security gate — scan OmniClaw repos + plugins for leaked API keys before every deploy",
    ...
    },
    {
        ...
        "usage": "OmniClaw LLM Router — integrates with ecosystem/skills/llm_router for resilient multi-provider routing",
        "install": "",
    },
    {
        "dir": "pm-skills",
        ...
        "usage": "Enhances strategy/product-manager-agent SKILL capability for OmniClaw Corp planning",
        "install": "",
    },
    {
    ...
    },
    {
        ...
        "usage": "Edge AI deployments — IoT sensor data ingestion → OmniClaw telemetry pipeline",
    ...
    },
    {
        ...
        "usage": "Media production pipeline — auto-generate multilingual subtitles for OmniClaw produced content",
    ...
    },
    {
        ...
        "usage": "OmniClaw API discovery — complements public-apis plugin with MCP-specific integrations",
        "install": "",
    },
    {
        ...
        "usage": "Onboarding reference for OmniClaw engineers joining the corp",
        "install": "",
    },
]
