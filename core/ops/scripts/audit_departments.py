...
def remediate_departments():
    remediations = {
        ...
        "brain/agents": "ecosystem/workforce/agents",
        "corp/memory/departments": "brain/knowledge/org",
        "shared-context/brain/corp/kpi_scoreboard.json": "brain/shared-context/kpi_targets.json",
        "corp/kpi_targets.yaml": "brain/shared-context/kpi_targets.json"
    }
