...
> [!WARNING]
> Thư mục này được bảo trì để phục vụ độc quyền cho **Kỹ sư & Người dùng thật**. Nếu bạn là một Trí Tuệ Nhân Tạo (AI MLLM) đang cố gắng đọc các quy tắc chạy hệ thống, bạn sẽ không thu được thông tin kỹ thuật nào ở đây. Vui lòng di chuyển sang thư mục lệnh `brain/rules/`.
...
- [**Đóng Gói & Đồng Bộ Dữ Liệu**](workflows/data_packaging_sync_vn.md) — Cách sao lưu bộ nhớ lên đám mây (HuggingFace/GDrive) cực an toàn.
...
## 🧠 Não Bộ Vận Hành (Operational Brain)
- [**brain/registry/**](../../brain/registry/_DIR_IDENTITY.md) - Sổ cái Trung tâm của Hệ thống V5.0. Được quản lý độc quyền bởi 2 Daemons OMA & OER. Chứa FAST_INDEX và SKILL_REGISTRY. CẤM CON NGƯỜI CHỈNH SỬA TAY.
