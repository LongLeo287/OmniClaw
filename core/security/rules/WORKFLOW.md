...
**When:** User says "start / read AI OS / boot"

```
BOOT sequence (strict order):
1. Read $OMNICLAW_ROOT\CLAUDE.md                  [ecosystem map]
2. Read $OMNICLAW_ROOT\rules\CLAUDE_CODE_MANAGER.md [if Claude Code]
