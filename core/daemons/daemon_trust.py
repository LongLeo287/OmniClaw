...
class PATHS:
    ...
    RAW_TRAIN       = "vault/archives/raw_repos/training_pipelines"
    RAW_BENCH       = "vault/archives/raw_repos/benchmarks"
    ...
    # LOGS - Garbage outputs generated during runtime
    LOGS_DIR        = "vault/tmp/logs"
    HANDOFF_LOG     = "vault/tmp/logs/handoff_tasks.log"
    CLI_LOG         = "vault/tmp/logs/cli_run.log"

    # SHARED CONTEXT - blackboard / AGENTS / activation
    BLACKBOARD      = "brain/memory/blackboard.json"
    AGENTS_ROSTER   = "brain/indices/FAST_AGENT_INDEX.json"
    ACTIVATION      = "brain/agents/activation_status.json"
    SYSTEM_ROUTER   = "brain/agents/system_router.json"
