...
*   **Do NOT** cram heavy imports (like `torch`, `puppeteer`, `cv2`) into the global `omniclaw` core.
...
*   *Reference:* Read the [Tier-2 Plugin Development Guide](https://github.com/LongLeo287/OmniClaw/wiki) on our Wiki.
