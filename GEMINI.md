...
```
OmniClaw cherry-pick tÃ¡Â»Â« everything-claude-code v1.9 (MIT, affaan-m).
KHÃƒâ€NG Ã„â€˜Ã¡Â»â„¢c quyÃ¡Â»Ân Claude Ã¢â‚¬â€ hÃ¡Â»â€” trÃ¡Â»Â£ Claude, Cursor, Codex, OpenCode.

Cherry-picked vÃƒÂ o OmniClaw:
...
```
Learned from: claude-inspector (kangraemin) Ã¢â‚¬â€ applied to ALL agents in OmniClaw
...
2. MCP TOOLS ARE LAZY-LOADED
   ...
   Ã¢â€ â€™ Validates OmniClaw 3-Tier lazy-load architecture.
...
Khi cáº§n dispatch task sang agent hoáº·c cáº­p nháº­t HUD:
  â†’ python system/ops/omniclaw_orchestrator.py once
...
Watch mode (poll má»—i 30s):
  â†’ python system/ops/omniclaw_orchestrator.py watch 30
