# 🔒 Chính Sách Bảo Mật (Security Policy) của OmniClaw Corp

> **"Mã Nguồn là Luật. Bảo Mật là Sinh Mệnh."**
> — THE OmniClaw ZERO-TRUST DIRECTIVE

Hệ sinh thái OmniClaw Corp vận hành dựa trên **Kiến Trúc ZERO-TRUST (Cấm Tin Tưởng Tuyệt Đối) Nghiêm Ngặt**. Chúng tôi coi vấn đề an ninh của hệ thống là ưu tiên số một và luôn trân trọng các báo cáo lỗ hổng có trách nhiệm.
...
Nếu Sếp/Kỹ sư phát hiện thấy một lỗ hổng trọng yếu, sự cố rò rỉ mã API Key, hay một Agent nào đó bị hack (Lỗi thực thi mã tùy ý - RCE), lộ lọt qua cổng kiểm duyệt, xin hãy báo cáo bí mật ngay lập tức:
...
Tập đoàn OmniClaw xin cảm tạ nhữg nỗ lực của bạn trong việc rào chắn cho Hệ Điều Hành bất khả xâm phạm!
